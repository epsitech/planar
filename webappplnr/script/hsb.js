function makeTdHsb(contdoc, w, pos, narrow) {
	...
	*/
	...
	// arrows
	/*
	<g id="HsbLeft" class="hsb" onmouseover="if(document.getElementById('tdHsb').onmousemove==null)document.getElementById('HsbLeftl').setAttribute('stroke','#ff7f00')" onmouseout="document.getElementById('HsbLeftl').setAttribute('stroke','black')" onclick="HsbLeftClick()">
	...
	*/
	...
	myg.setAttribute("onclick", "HsbLeftClick()");
	...
	myg.setAttribute("onclick", "HsbRightClick()");
	...
	*/
	...
	/*
	<g class="hsb" onmouseover="if(document.getElementById('tdHsb').onmousemove==null)document.getElementById('HsbJpleftl').setAttribute('stroke','#ff7f00')" onmouseout="document.getElementById('HsbJpleftl').setAttribute('stroke','black')" onclick="HsbJpleftClick()">
	...
	*/
	...
	myg.setAttribute("onclick", "HsbJpleftClick()");
	...
	myg.setAttribute("onclick", "HsbJprightClick()");
	...
	// slider
	/*
	<g id="Hsb" class="hsb" transform="translate(0 225)" onmouseover="document.getElementById('HsbBar').setAttribute('stroke','#ff7f00')" onmouseout="if(document.getElementById('tdHsb').onmousemove==null)document.getElementById('HsbBar').setAttribute('stroke','black')" onmousedown="HsbMdn()">
	...
	*/
	...
	myg.setAttribute("onmousedown", "HsbMdn()");
