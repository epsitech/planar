function makeTdVsb(contdoc, h, pos, narrow) {
	...
	*/
	...
	// arrows
	/*
	<g id="VsbUp" class="vsb" onmouseover="if(document.getElementById('tdVsb').onmousemove==null)document.getElementById('VsbUpl').setAttribute('stroke','#ff7f00')" onmouseout="document.getElementById('VsbUpl').setAttribute('stroke','black')" onclick="VsbUpClick()">
	...
	*/
	...
	myg.setAttribute("onclick", "VsbUpClick()");
	...
	myg.setAttribute("onclick", "VsbDownClick()");
	...
	*/
	...
	/*
	<g class="vsb" onmouseover="if(document.getElementById('tdVsb').onmousemove==null)document.getElementById('VsbJpupl').setAttribute('stroke','#ff7f00')" onmouseout="document.getElementById('VsbJpupl').setAttribute('stroke','black')" onclick="VsbJpupClick()">
	...
	*/
	...
	myg.setAttribute("onclick", "VsbJpupClick()");
	...
	myg.setAttribute("onclick", "VsbJpdownClick()");
	...
	// slider
	/*
	<g id="Vsb" class="vsb" transform="translate(0 225)" onmouseover="document.getElementById('VsbBar').setAttribute('stroke','#ff7f00')" onmouseout="if(document.getElementById('tdVsb').onmousemove==null)document.getElementById('VsbBar').setAttribute('stroke','black')" onmousedown="VsbMdn()">
	...
	*/
	...
	myg.setAttribute("onmousedown", "VsbMdn()");
