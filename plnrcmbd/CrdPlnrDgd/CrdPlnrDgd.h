/**
  * \file CrdPlnrDgd.h
  * job handler for job CrdPlnrDgd (declarations)
...
/**
  * CrdPlnrDgd
  */
class CrdPlnrDgd : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrDgdDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDDGD = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdDgd = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrDgdDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrDgdData)
		*/
...
public:
	CrdPlnrDgd(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0, const uint ixPlnrVPreset = VecPlnrVPreset::VOID, const ubigint preUref = 0);
	~CrdPlnrDgd();
...
public:
	...
	PnlPlnrDgdRec* pnlrec;
	PnlPlnrDgdHeadbar* pnlheadbar;
	PnlPlnrDgdList* pnllist;
