/**
  ...
  * job handler for job PnlPlnrDgdList (declarations)
...
/**
  * PnlPlnrDgdList
  */
class PnlPlnrDgdList : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDgdList* rst = NULL, QryPlnrDgdList::StatShr* statshrqry = NULL, QryPlnrDgdList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrDgdList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDgdList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDgdList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
