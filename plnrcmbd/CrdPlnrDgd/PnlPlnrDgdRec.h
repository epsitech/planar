/**
  * \file PnlPlnrDgdRec.h
  * job handler for job PnlPlnrDgdRec (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRDGDREC_H
#define PNLPLNRDGDREC_H
...
/**
  * PnlPlnrDgdRec
  */
class PnlPlnrDgdRec : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrDgdRecDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrDgdRec)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrDgdRec)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrDgdRec)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrDgdRecDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrDgdRecData)
		*/
...
// IP constructor --- BEGIN
	PnlPlnrDgdRec(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDgdRec();
