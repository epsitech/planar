/**
  ...
  * job handler for job QryPlnrCtpKParProp (declarations)
...
/**
  * QryPlnrCtpKParProp
  */
class QryPlnrCtpKParProp : public JobPlnr {
...
// IP constructor --- BEGIN
	QryPlnrCtpKParProp(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrCtpKParProp();
