/**
  * \file QryPlnrCtpList.h
  * job handler for job QryPlnrCtpList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRCTPLIST_H
#define QRYPLNRCTPLIST_H
...
/**
  * QryPlnrCtpList
  */
class QryPlnrCtpList : public JobPlnr {

public:
	/**
		* VecVOrd (full: VecVQryPlnrCtpListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryPlnrCtpList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrCtpList)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrCtpList)
		*/
...
// IP constructor --- BEGIN
	QryPlnrCtpList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrCtpList();
