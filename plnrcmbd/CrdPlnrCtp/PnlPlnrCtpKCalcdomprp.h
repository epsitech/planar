/**
  ...
  * job handler for job PnlPlnrCtpKCalcdomprp (declarations)
...
/**
  ...
  */
class PnlPlnrCtpKCalcdomprp : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQCtpKCalcdomprp* rst = NULL, QryPlnrCtpKCalcdomprp::StatShr* statshrqry = NULL, QryPlnrCtpKCalcdomprp::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrCtpKCalcdomprp(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrCtpKCalcdomprp();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrCtpKCalcdomprp::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
