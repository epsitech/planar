/**
  * \file QryPlnrCtpKCalcvar.h
  * job handler for job QryPlnrCtpKCalcvar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRCTPKCALCVAR_H
#define QRYPLNRCTPKCALCVAR_H
...
/**
  * QryPlnrCtpKCalcvar
  */
class QryPlnrCtpKCalcvar : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrCtpKCalcvar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrCtpKCalcvar)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrCtpKCalcvar)
		*/
...
// IP constructor --- BEGIN
	QryPlnrCtpKCalcvar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrCtpKCalcvar();
