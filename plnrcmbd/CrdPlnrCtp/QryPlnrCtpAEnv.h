/**
  * \file QryPlnrCtpAEnv.h
  * job handler for job QryPlnrCtpAEnv (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRCTPAENV_H
#define QRYPLNRCTPAENV_H
...
/**
  * QryPlnrCtpAEnv
  */
class QryPlnrCtpAEnv : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrCtpAEnv)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrCtpAEnv)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrCtpAEnv)
		*/
...
// IP constructor --- BEGIN
	QryPlnrCtpAEnv(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrCtpAEnv();
