/**
  ...
  * job handler for job PnlPlnrCtpKEnvKey (declarations)
...
/**
  * PnlPlnrCtpKEnvKey
  */
class PnlPlnrCtpKEnvKey : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQCtpKEnvKey* rst = NULL, QryPlnrCtpKEnvKey::StatShr* statshrqry = NULL, QryPlnrCtpKEnvKey::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrCtpKEnvKey(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrCtpKEnvKey();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrCtpKEnvKey::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
