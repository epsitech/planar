/**
  * \file PnlPlnrCtpAPar.h
  * job handler for job PnlPlnrCtpAPar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRCTPAPAR_H
#define PNLPLNRCTPAPAR_H
...
/**
  * PnlPlnrCtpAPar
  */
class PnlPlnrCtpAPar : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrCtpAParDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrCtpAPar)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrCtpAPar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrCtpAPar)
		*/
	...
	/**
		* DpchAppData (full: DpchAppPlnrCtpAParData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrCtpAParDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrCtpAParData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQCtpAPar* rst = NULL, QryPlnrCtpAPar::StatShr* statshrqry = NULL, QryPlnrCtpAPar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrCtpAPar::StatShr statshrqry;
		QryPlnrCtpAPar::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlPlnrCtpAPar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrCtpAPar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrCtpAPar::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
