/**
  ...
  * job handler for job PnlPlnrCtpKCalcvar (declarations)
...
/**
  * PnlPlnrCtpKCalcvar
  */
class PnlPlnrCtpKCalcvar : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQCtpKCalcvar* rst = NULL, QryPlnrCtpKCalcvar::StatShr* statshrqry = NULL, QryPlnrCtpKCalcvar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrCtpKCalcvar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrCtpKCalcvar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrCtpKCalcvar::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
