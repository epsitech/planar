/**
  * \file QryPlnrCtpKEnvKey.h
  * job handler for job QryPlnrCtpKEnvKey (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRCTPKENVKEY_H
#define QRYPLNRCTPKENVKEY_H
...
/**
  * QryPlnrCtpKEnvKey
  */
class QryPlnrCtpKEnvKey : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrCtpKEnvKey)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrCtpKEnvKey)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrCtpKEnvKey)
		*/
...
// IP constructor --- BEGIN
	QryPlnrCtpKEnvKey(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrCtpKEnvKey();
