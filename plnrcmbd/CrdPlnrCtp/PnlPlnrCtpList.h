/**
  * \file PnlPlnrCtpList.h
  * job handler for job PnlPlnrCtpList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRCTPLIST_H
#define PNLPLNRCTPLIST_H
...
/**
  * PnlPlnrCtpList
  */
class PnlPlnrCtpList : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrCtpListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacPlnrCtpList)
	  */
	...
	/**
	  * ContInf (full: ContInfPlnrCtpList)
	  */
	...
	/**
		* StatShr (full: StatShrPlnrCtpList)
		*/
	...
	/**
		* StgIac (full: StgIacPlnrCtpList)
		*/
	class StgIac : public Block {

	public:
		static const uint TCOTITWIDTH = 1;
		static const uint TCODIMWIDTH = 2;
		static const uint TCOSUPWIDTH = 3;

	public:
		StgIac(const uint TcoTitWidth = 100, const uint TcoDimWidth = 100, const uint TcoSupWidth = 100);
	...
	/**
		* DpchAppData (full: DpchAppPlnrCtpListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrCtpListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrCtpListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQCtpList* rst = NULL, QryPlnrCtpList::StatShr* statshrqry = NULL, QryPlnrCtpList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrCtpList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrCtpList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrCtpList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
