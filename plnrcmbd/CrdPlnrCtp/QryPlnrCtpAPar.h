/**
  * \file QryPlnrCtpAPar.h
  * job handler for job QryPlnrCtpAPar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRCTPAPAR_H
#define QRYPLNRCTPAPAR_H
...
/**
  * QryPlnrCtpAPar
  */
class QryPlnrCtpAPar : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrCtpAPar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrCtpAPar)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrCtpAPar)
		*/
...
// IP constructor --- BEGIN
	QryPlnrCtpAPar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrCtpAPar();
