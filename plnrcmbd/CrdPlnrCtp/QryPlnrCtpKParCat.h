/**
  * \file QryPlnrCtpKParCat.h
  * job handler for job QryPlnrCtpKParCat (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRCTPKPARCAT_H
#define QRYPLNRCTPKPARCAT_H
...
/**
  * QryPlnrCtpKParCat
  */
class QryPlnrCtpKParCat : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrCtpKParCat)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrCtpKParCat)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrCtpKParCat)
		*/
...
// IP constructor --- BEGIN
	QryPlnrCtpKParCat(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrCtpKParCat();
