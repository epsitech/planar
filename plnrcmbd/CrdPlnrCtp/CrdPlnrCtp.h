/**
  * \file CrdPlnrCtp.h
  * job handler for job CrdPlnrCtp (declarations)
...
/**
  * CrdPlnrCtp
  */
class CrdPlnrCtp : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrCtpDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDCTP = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdCtp = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrCtpDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrCtpData)
		*/
...
public:
	CrdPlnrCtp(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0);
	~CrdPlnrCtp();
...
public:
	...
	PnlPlnrCtpRec* pnlrec;
	PnlPlnrCtpHeadbar* pnlheadbar;
	PnlPlnrCtpList* pnllist;
