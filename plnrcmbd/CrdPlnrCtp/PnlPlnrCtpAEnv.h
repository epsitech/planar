/**
  * \file PnlPlnrCtpAEnv.h
  * job handler for job PnlPlnrCtpAEnv (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRCTPAENV_H
#define PNLPLNRCTPAENV_H
...
/**
  * PnlPlnrCtpAEnv
  */
class PnlPlnrCtpAEnv : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrCtpAEnvDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrCtpAEnv)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrCtpAEnv)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrCtpAEnv)
		*/
	...
	/**
		* DpchAppData (full: DpchAppPlnrCtpAEnvData)
		*/
	...
	public:
		StgIac stgiac;
		QryPlnrCtpAEnv::StgIac stgiacqry;
	...
	/**
		* DpchAppDo (full: DpchAppPlnrCtpAEnvDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrCtpAEnvData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQCtpAEnv* rst = NULL, QryPlnrCtpAEnv::StatShr* statshrqry = NULL, QryPlnrCtpAEnv::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrCtpAEnv::StatShr statshrqry;
		QryPlnrCtpAEnv::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlPlnrCtpAEnv(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrCtpAEnv();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrCtpAEnv::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
