/**
  * \file PnlPlnrStkList_blks.cpp
  * job handler for job PnlPlnrStkList (implementation of blocks)
...
/******************************************************************************
 class PnlPlnrStkList::VecVDo
 ******************************************************************************/

uint PnlPlnrStkList::VecVDo::getIx(
			const string& sref
		) {
...
string PnlPlnrStkList::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class PnlPlnrStkList::ContIac
 ******************************************************************************/

PnlPlnrStkList::ContIac::ContIac(
			const uint numFTos
		) : Block() {
...
bool PnlPlnrStkList::ContIac::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContIacPlnrStkList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemIacPlnrStkList";
...
void PnlPlnrStkList::ContIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "ContIacPlnrStkList";

	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemIacPlnrStkList";
...
set<uint> PnlPlnrStkList::ContIac::comm(
			const ContIac* comp
		) {
	set<uint> items;
...
set<uint> PnlPlnrStkList::ContIac::diff(
			const ContIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlPlnrStkList::ContInf
 ******************************************************************************/

PnlPlnrStkList::ContInf::ContInf(
			const string& TxtFor
			, const string& TxtPre
...
void PnlPlnrStkList::ContInf::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "ContInfPlnrStkList";

	string itemtag;
	if (shorttags) itemtag = "Ci";
	else itemtag = "ContitemInfPlnrStkList";
...
set<uint> PnlPlnrStkList::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
...
set<uint> PnlPlnrStkList::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlPlnrStkList::StatShr
 ******************************************************************************/

PnlPlnrStkList::StatShr::StatShr(
...
void PnlPlnrStkList::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StatShrPlnrStkList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrPlnrStkList";
...
set<uint> PnlPlnrStkList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> PnlPlnrStkList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class PnlPlnrStkList::StgIac
 ******************************************************************************/

PnlPlnrStkList::StgIac::StgIac(
	...
	mask = {TCOSRFWIDTH, TCOTYPWIDTH, TCODSNWIDTH, TCOMTYWIDTH, TCOFALWIDTH, TCOCALWIDTH};
};

bool PnlPlnrStkList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacPlnrStkList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacPlnrStkList";
...
void PnlPlnrStkList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacPlnrStkList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacPlnrStkList";
...
set<uint> PnlPlnrStkList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> PnlPlnrStkList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {TCOSRFWIDTH, TCOTYPWIDTH, TCODSNWIDTH, TCOMTYWIDTH, TCOFALWIDTH, TCOCALWIDTH};
	for (auto it=commitems.begin();it!=commitems.end();it++) diffitems.erase(*it);
...
/******************************************************************************
 class PnlPlnrStkList::Tag
 ******************************************************************************/

void PnlPlnrStkList::Tag::writeXML(
			const uint ixPlnrVLocale
			, xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "TagPlnrStkList";

	string itemtag;
	if (shorttags) itemtag = "Ti";
	else itemtag = "TagitemPlnrStkList";
	...
	xmlTextWriterStartElement(wr, BAD_CAST difftag.c_str());
		if (ixPlnrVLocale == VecPlnrVLocale::ENUS) {
			...
			writeStringAttr(wr, itemtag, "sref", "TcoFal", "Floor align type");
			writeStringAttr(wr, itemtag, "sref", "TcoCal", "Ceiling align type");
		};
...
/******************************************************************************
 class PnlPlnrStkList::DpchAppData
 ******************************************************************************/

PnlPlnrStkList::DpchAppData::DpchAppData() : DpchAppPlnr(VecPlnrVDpch::DPCHAPPPLNRSTKLISTDATA) {
};

void PnlPlnrStkList::DpchAppData::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppPlnrStkListData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		contiac = ContIac();
		stgiac = StgIac();
		stgiacqry = QryPlnrStkList::StgIac();
	};
};

/******************************************************************************
 class PnlPlnrStkList::DpchAppDo
 ******************************************************************************/

PnlPlnrStkList::DpchAppDo::DpchAppDo() : DpchAppPlnr(VecPlnrVDpch::DPCHAPPPLNRSTKLISTDO) {
	ixVDo = 0;
};

void PnlPlnrStkList::DpchAppDo::readXML(
			pthread_mutex_t* mScr
			, map<string,ubigint>& descr
			, xmlXPathContext* docctx
			, string basexpath
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchAppPlnrStkListDo");
	else
		basefound = checkXPath(docctx, basexpath);
...
/******************************************************************************
 class PnlPlnrStkList::DpchEngData
 ******************************************************************************/

PnlPlnrStkList::DpchEngData::DpchEngData(
			const ubigint jref
			, ContIac* contiac
			, ContInf* continf
			, Feed* feedFCsiQst
			...
			, const set<uint>& mask
		) : DpchEngPlnr(VecPlnrVDpch::DPCHENGPLNRSTKLISTDATA, jref) {
...
void PnlPlnrStkList::DpchEngData::merge(
			DpchEngPlnr* dpcheng
		) {
...
void PnlPlnrStkList::DpchEngData::writeXML(
			const uint ixPlnrVLocale
			, pthread_mutex_t* mScr
	...
	xmlTextWriterStartElement(wr, BAD_CAST "DpchEngPlnrStkListData");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/plnr");
		...
		if (has(STATAPPQRY)) QryPlnrStkList::StatApp::writeXML(wr);
