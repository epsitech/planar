/**
  * \file CrdPlnrStk.h
  * job handler for job CrdPlnrStk (declarations)
...
/**
  * CrdPlnrStk
  */
class CrdPlnrStk : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrStkDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDSTK = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdStk = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrStkDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrStkData)
		*/
...
public:
	CrdPlnrStk(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0, const uint ixPlnrVPreset = VecPlnrVPreset::VOID, const ubigint preUref = 0);
	~CrdPlnrStk();
...
public:
	...
	PnlPlnrStkRec* pnlrec;
	PnlPlnrStkHeadbar* pnlheadbar;
	PnlPlnrStkList* pnllist;
