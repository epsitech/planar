/**
  * \file QryPlnrStkList.h
  * job handler for job QryPlnrStkList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRSTKLIST_H
#define QRYPLNRSTKLIST_H
...
/**
  * QryPlnrStkList
  */
class QryPlnrStkList : public JobPlnr {

public:
	/**
		* VecVOrd (full: VecVQryPlnrStkListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryPlnrStkList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrStkList)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrStkList)
		*/
...
// IP constructor --- BEGIN
	QryPlnrStkList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrStkList();
...
// IP handleCall --- END
	...
	bool handleCallPlnrStkMod(DbsPlnr* dbsplnr, const ubigint jrefTrig);
