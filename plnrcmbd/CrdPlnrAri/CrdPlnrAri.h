/**
  * \file CrdPlnrAri.h
  * job handler for job CrdPlnrAri (declarations)
...
/**
  * CrdPlnrAri
  */
class CrdPlnrAri : public JobPlnr {
...
public:
	CrdPlnrAri(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0, const uint ixPlnrVPreset = VecPlnrVPreset::VOID, const ubigint preUref = 0);
	~CrdPlnrAri();
...
public:
	...
	PnlPlnrAriRec* pnlrec;
	PnlPlnrAriHeadbar* pnlheadbar;
	PnlPlnrAriList* pnllist;
