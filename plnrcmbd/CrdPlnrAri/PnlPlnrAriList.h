/**
  ...
  * job handler for job PnlPlnrAriList (declarations)
...
/**
  * PnlPlnrAriList
  */
class PnlPlnrAriList : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQAriList* rst = NULL, QryPlnrAriList::StatShr* statshrqry = NULL, QryPlnrAriList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrAriList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrAriList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrAriList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
