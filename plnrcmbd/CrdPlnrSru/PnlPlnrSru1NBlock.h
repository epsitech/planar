/**
  ...
  * job handler for job PnlPlnrSru1NBlock (declarations)
...
/**
  * PnlPlnrSru1NBlock
  */
class PnlPlnrSru1NBlock : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQSru1NBlock* rst = NULL, QryPlnrSru1NBlock::StatShr* statshrqry = NULL, QryPlnrSru1NBlock::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrSru1NBlock(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrSru1NBlock();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrSru1NBlock::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
