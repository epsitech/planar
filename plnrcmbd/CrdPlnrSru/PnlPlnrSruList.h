/**
  ...
  * job handler for job PnlPlnrSruList (declarations)
...
/**
  * PnlPlnrSruList
  */
class PnlPlnrSruList : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQSruList* rst = NULL, QryPlnrSruList::StatShr* statshrqry = NULL, QryPlnrSruList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrSruList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrSruList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrSruList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
