/**
  ...
  * job handler for job PnlPlnrSruMNLayer (declarations)
...
/**
  * PnlPlnrSruMNLayer
  */
class PnlPlnrSruMNLayer : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQSruMNLayer* rst = NULL, QryPlnrSruMNLayer::StatShr* statshrqry = NULL, QryPlnrSruMNLayer::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrSruMNLayer(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrSruMNLayer();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrSruMNLayer::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
