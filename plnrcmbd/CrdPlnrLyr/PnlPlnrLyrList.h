/**
  * \file PnlPlnrLyrList.h
  * job handler for job PnlPlnrLyrList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRLYRLIST_H
#define PNLPLNRLYRLIST_H
...
/**
  * PnlPlnrLyrList
  */
class PnlPlnrLyrList : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrLyrListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacPlnrLyrList)
	  */
	...
	/**
	  * ContInf (full: ContInfPlnrLyrList)
	  */
	...
	/**
		* StatShr (full: StatShrPlnrLyrList)
		*/
	...
	public:
		...
		static const uint TCOMATWIDTH = 5;
		static const uint TCOTTYWIDTH = 6;

	public:
		StgIac(const uint TcoSrfWidth = 100, const uint TcoTypWidth = 100, const uint TcoHktWidth = 100, const uint TcoHkuWidth = 100, const uint TcoMatWidth = 100, const uint TcoTtyWidth = 100);
	...
	/**
		* DpchAppData (full: DpchAppPlnrLyrListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrLyrListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrLyrListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQLyrList* rst = NULL, QryPlnrLyrList::StatShr* statshrqry = NULL, QryPlnrLyrList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrLyrList::StatShr statshrqry;
		QryPlnrLyrList::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlPlnrLyrList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrLyrList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrLyrList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
