/**
  * \file CrdPlnrLyr.h
  * job handler for job CrdPlnrLyr (declarations)
...
/**
  * CrdPlnrLyr
  */
class CrdPlnrLyr : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrLyrDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDLYR = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdLyr = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrLyrDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrLyrData)
		*/
...
public:
	CrdPlnrLyr(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0, const uint ixPlnrVPreset = VecPlnrVPreset::VOID, const ubigint preUref = 0);
	~CrdPlnrLyr();
...
public:
	...
	PnlPlnrLyrRec* pnlrec;
	PnlPlnrLyrHeadbar* pnlheadbar;
	PnlPlnrLyrList* pnllist;
