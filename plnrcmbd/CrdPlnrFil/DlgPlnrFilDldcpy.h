/**
  ...
  * job handler for job DlgPlnrFilDldcpy (declarations)
...
/**
  * DlgPlnrFilDldcpy
  */
class DlgPlnrFilDldcpy : public JobPlnr {
...
// IP constructor --- BEGIN
	DlgPlnrFilDldcpy(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~DlgPlnrFilDldcpy();
