/**
  * \file QryPlnrFilList.h
  * job handler for job QryPlnrFilList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRFILLIST_H
#define QRYPLNRFILLIST_H
...
/**
  * QryPlnrFilList
  */
class QryPlnrFilList : public JobPlnr {

public:
	/**
		* VecVOrd (full: VecVQryPlnrFilListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryPlnrFilList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrFilList)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrFilList)
		*/
...
// IP constructor --- BEGIN
	QryPlnrFilList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrFilList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const string& preFnm, const uint preRet, const ubigint preReu, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallPlnrFilMod(DbsPlnr* dbsplnr, const ubigint jrefTrig);
