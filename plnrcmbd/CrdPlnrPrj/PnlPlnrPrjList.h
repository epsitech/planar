/**
  * \file PnlPlnrPrjList.h
  * job handler for job PnlPlnrPrjList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRPRJLIST_H
#define PNLPLNRPRJLIST_H
...
/**
  * PnlPlnrPrjList
  */
class PnlPlnrPrjList : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrPrjListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacPlnrPrjList)
	  */
	...
	/**
	  * ContInf (full: ContInfPlnrPrjList)
	  */
	...
	/**
		* StatShr (full: StatShrPlnrPrjList)
		*/
	...
	/**
		* StgIac (full: StgIacPlnrPrjList)
		*/
	class StgIac : public Block {

	public:
		static const uint TCOTITWIDTH = 1;
		static const uint TCOSTEWIDTH = 2;

	public:
		StgIac(const uint TcoTitWidth = 100, const uint TcoSteWidth = 100);
	...
	/**
		* DpchAppData (full: DpchAppPlnrPrjListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrPrjListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrPrjListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQPrjList* rst = NULL, QryPlnrPrjList::StatShr* statshrqry = NULL, QryPlnrPrjList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrPrjList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrPrjList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrPrjList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
