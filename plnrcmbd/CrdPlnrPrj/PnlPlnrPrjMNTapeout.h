/**
  * \file PnlPlnrPrjMNTapeout.h
  * job handler for job PnlPlnrPrjMNTapeout (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRPRJMNTAPEOUT_H
#define PNLPLNRPRJMNTAPEOUT_H
...
/**
  * PnlPlnrPrjMNTapeout
  */
class PnlPlnrPrjMNTapeout : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrPrjMNTapeoutDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrPrjMNTapeout)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrPrjMNTapeout)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrPrjMNTapeout)
		*/
	...
	/**
		* StgIac (full: StgIacPlnrPrjMNTapeout)
		*/
	...
	/**
		* DpchAppData (full: DpchAppPlnrPrjMNTapeoutData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrPrjMNTapeoutDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrPrjMNTapeoutData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQPrjMNTapeout* rst = NULL, QryPlnrPrjMNTapeout::StatShr* statshrqry = NULL, QryPlnrPrjMNTapeout::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrPrjMNTapeout(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrPrjMNTapeout();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrPrjMNTapeout::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
