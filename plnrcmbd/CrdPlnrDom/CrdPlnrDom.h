/**
  * \file CrdPlnrDom.h
  * job handler for job CrdPlnrDom (declarations)
...
/**
  * CrdPlnrDom
  */
class CrdPlnrDom : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrDomDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDDOM = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdDom = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrDomDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrDomData)
		*/
...
public:
	CrdPlnrDom(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0, const uint ixPlnrVPreset = VecPlnrVPreset::VOID, const ubigint preUref = 0);
	~CrdPlnrDom();
...
public:
	...
	PnlPlnrDomRec* pnlrec;
	PnlPlnrDomHeadbar* pnlheadbar;
	PnlPlnrDomList* pnllist;
