/**
  ...
  * job handler for job PnlPlnrDomList (declarations)
...
/**
  * PnlPlnrDomList
  */
class PnlPlnrDomList : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDomList* rst = NULL, QryPlnrDomList::StatShr* statshrqry = NULL, QryPlnrDomList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrDomList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDomList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDomList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
