/**
  * \file CrdPlnrUsr.h
  * job handler for job CrdPlnrUsr (declarations)
...
/**
  * CrdPlnrUsr
  */
class CrdPlnrUsr : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrUsrDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppPlnrUsrDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrUsrData)
		*/
...
public:
	CrdPlnrUsr(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0);
	~CrdPlnrUsr();
...
public:
	...
	PnlPlnrUsrRec* pnlrec;
	PnlPlnrUsrHeadbar* pnlheadbar;
	PnlPlnrUsrList* pnllist;
