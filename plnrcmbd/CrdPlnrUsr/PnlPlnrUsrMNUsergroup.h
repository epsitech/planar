/**
  ...
  * job handler for job PnlPlnrUsrMNUsergroup (declarations)
...
/**
  ...
  */
class PnlPlnrUsrMNUsergroup : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQUsrMNUsergroup* rst = NULL, QryPlnrUsrMNUsergroup::StatShr* statshrqry = NULL, QryPlnrUsrMNUsergroup::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrUsrMNUsergroup(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrUsrMNUsergroup();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrUsrMNUsergroup::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
