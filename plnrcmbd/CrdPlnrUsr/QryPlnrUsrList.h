/**
  * \file QryPlnrUsrList.h
  * job handler for job QryPlnrUsrList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRUSRLIST_H
#define QRYPLNRUSRLIST_H
...
/**
  * QryPlnrUsrList
  */
class QryPlnrUsrList : public JobPlnr {

public:
	/**
		* VecVOrd (full: VecVQryPlnrUsrListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryPlnrUsrList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrUsrList)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrUsrList)
		*/
...
// IP constructor --- BEGIN
	QryPlnrUsrList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrUsrList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const ubigint prePrs, const string& preSrf, const ubigint preUsg, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallPlnrUsrMod(DbsPlnr* dbsplnr, const ubigint jrefTrig);
