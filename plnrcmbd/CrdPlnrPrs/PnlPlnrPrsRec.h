/**
  * \file PnlPlnrPrsRec.h
  * job handler for job PnlPlnrPrsRec (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRPRSREC_H
#define PNLPLNRPRSREC_H
...
/**
  * PnlPlnrPrsRec
  */
class PnlPlnrPrsRec : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrPrsRecDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrPrsRec)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrPrsRec)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrPrsRec)
		*/
	...
	public:
		StatShr(const uint ixPlnrVExpstate = VecPlnrVExpstate::REGD, const ubigint jrefDetail = 0, const ubigint jrefADetail = 0, const bool ButRegularizeActive = true);
	...
	/**
		* DpchAppDo (full: DpchAppPlnrPrsRecDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrPrsRecData)
		*/
...
// IP constructor --- BEGIN
	PnlPlnrPrsRec(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrPrsRec();
...
public:
	...
	PnlPlnrPrsDetail* pnldetail;
	PnlPlnrPrsADetail* pnladetail;
