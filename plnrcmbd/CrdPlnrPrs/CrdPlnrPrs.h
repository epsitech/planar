/**
  * \file CrdPlnrPrs.h
  * job handler for job CrdPlnrPrs (declarations)
...
/**
  * CrdPlnrPrs
  */
class CrdPlnrPrs : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrPrsDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppPlnrPrsDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrPrsData)
		*/
...
public:
	CrdPlnrPrs(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0);
	~CrdPlnrPrs();
...
public:
	...
	PnlPlnrPrsRec* pnlrec;
	PnlPlnrPrsHeadbar* pnlheadbar;
	PnlPlnrPrsList* pnllist;
