/**
  ...
  * job handler for job PnlPlnrPrsADetail (declarations)
...
/**
  * PnlPlnrPrsADetail
  */
class PnlPlnrPrsADetail : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQPrsADetail* rst = NULL, QryPlnrPrsADetail::StatShr* statshrqry = NULL, QryPlnrPrsADetail::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrPrsADetail(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrPrsADetail();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrPrsADetail::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
