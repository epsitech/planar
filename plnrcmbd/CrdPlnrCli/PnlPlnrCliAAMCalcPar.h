/**
  ...
  * job handler for job PnlPlnrCliAAMCalcPar (declarations)
...
/**
  ...
  */
class PnlPlnrCliAAMCalcPar : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQCliAAMCalcPar* rst = NULL, QryPlnrCliAAMCalcPar::StatShr* statshrqry = NULL, QryPlnrCliAAMCalcPar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrCliAAMCalcPar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrCliAAMCalcPar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrCliAAMCalcPar::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
