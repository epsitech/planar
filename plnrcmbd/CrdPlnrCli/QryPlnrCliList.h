/**
  * \file QryPlnrCliList.h
  * job handler for job QryPlnrCliList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRCLILIST_H
#define QRYPLNRCLILIST_H
...
/**
  * QryPlnrCliList
  */
class QryPlnrCliList : public JobPlnr {

public:
	/**
		* VecVOrd (full: VecVQryPlnrCliListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryPlnrCliList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrCliList)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrCliList)
		*/
...
// IP constructor --- BEGIN
	QryPlnrCliList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrCliList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const string& preTit, const ubigint preCal, const ubigint preDsn, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallPlnrCliMod(DbsPlnr* dbsplnr, const ubigint jrefTrig);
