/**
  * \file CrdPlnrCli.h
  * job handler for job CrdPlnrCli (declarations)
...
/**
  * CrdPlnrCli
  */
class CrdPlnrCli : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrCliDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDCLI = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdCli = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrCliDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrCliData)
		*/
...
public:
	CrdPlnrCli(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0, const uint ixPlnrVPreset = VecPlnrVPreset::VOID, const ubigint preUref = 0);
	~CrdPlnrCli();
...
public:
	...
	PnlPlnrCliRec* pnlrec;
	PnlPlnrCliHeadbar* pnlheadbar;
	PnlPlnrCliList* pnllist;
