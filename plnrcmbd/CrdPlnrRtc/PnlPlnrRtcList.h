/**
  ...
  * job handler for job PnlPlnrRtcList (declarations)
...
/**
  * PnlPlnrRtcList
  */
class PnlPlnrRtcList : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQRtcList* rst = NULL, QryPlnrRtcList::StatShr* statshrqry = NULL, QryPlnrRtcList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrRtcList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrRtcList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrRtcList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
