/**
  * \file CrdPlnrRtc.h
  * job handler for job CrdPlnrRtc (declarations)
...
/**
  * CrdPlnrRtc
  */
class CrdPlnrRtc : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrRtcDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDRTC = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdRtc = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrRtcDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrRtcData)
		*/
...
public:
	CrdPlnrRtc(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0, const uint ixPlnrVPreset = VecPlnrVPreset::VOID, const ubigint preUref = 0);
	~CrdPlnrRtc();
...
public:
	...
	PnlPlnrRtcRec* pnlrec;
	PnlPlnrRtcHeadbar* pnlheadbar;
	PnlPlnrRtcList* pnllist;
