/**
  ...
  * job handler for job PnlPlnrDvcDetail (declarations)
...
/**
  * PnlPlnrDvcDetail
  */
class PnlPlnrDvcDetail : public JobPlnr {
...
// IP constructor --- BEGIN
	PnlPlnrDvcDetail(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDvcDetail();
