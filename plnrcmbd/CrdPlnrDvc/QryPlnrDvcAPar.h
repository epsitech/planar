/**
  * \file QryPlnrDvcAPar.h
  * job handler for job QryPlnrDvcAPar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRDVCAPAR_H
#define QRYPLNRDVCAPAR_H
...
/**
  * QryPlnrDvcAPar
  */
class QryPlnrDvcAPar : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrDvcAPar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrDvcAPar)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrDvcAPar)
		*/
...
// IP constructor --- BEGIN
	QryPlnrDvcAPar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrDvcAPar();
