/**
  ...
  * job handler for job PnlPlnrDvcAPar (declarations)
...
/**
  * PnlPlnrDvcAPar
  */
class PnlPlnrDvcAPar : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDvcAPar* rst = NULL, QryPlnrDvcAPar::StatShr* statshrqry = NULL, QryPlnrDvcAPar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrDvcAPar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDvcAPar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDvcAPar::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
