/**
  ...
  * job handler for job PnlPlnrDvcView (declarations)
...
/**
  * PnlPlnrDvcView
  */
class PnlPlnrDvcView : public JobPlnr {
...
// IP constructor --- BEGIN
	PnlPlnrDvcView(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDvcView();
