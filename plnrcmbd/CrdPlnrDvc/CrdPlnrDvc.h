/**
  * \file CrdPlnrDvc.h
  * job handler for job CrdPlnrDvc (declarations)
...
/**
  * CrdPlnrDvc
  */
class CrdPlnrDvc : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrDvcDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDDVC = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdDvc = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrDvcDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrDvcData)
		*/
...
public:
	CrdPlnrDvc(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0, const uint ixPlnrVPreset = VecPlnrVPreset::VOID, const ubigint preUref = 0);
	~CrdPlnrDvc();
...
public:
	...
	PnlPlnrDvcRec* pnlrec;
	PnlPlnrDvcHeadbar* pnlheadbar;
	PnlPlnrDvcList* pnllist;
