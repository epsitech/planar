/**
  * \file QryPlnrDvcList.h
  * job handler for job QryPlnrDvcList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRDVCLIST_H
#define QRYPLNRDVCLIST_H
...
/**
  * QryPlnrDvcList
  */
class QryPlnrDvcList : public JobPlnr {

public:
	/**
		* VecVOrd (full: VecVQryPlnrDvcListOrd)
		*/
	class VecVOrd {

	public:
		static const uint SRF = 1;
		static const uint DSN = 2;
	...
	/**
		* StatApp (full: StatAppQryPlnrDvcList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrDvcList)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrDvcList)
		*/
...
// IP constructor --- BEGIN
	QryPlnrDvcList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrDvcList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const string& preSrf, const ubigint preDsn, const ubigint preSup, const ubigint preTpl, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallPlnrDevMod(DbsPlnr* dbsplnr, const ubigint jrefTrig);
