/**
  ...
  * job handler for job QryPlnrDsnHk1NStructure (declarations)
...
/**
  ...
  */
class QryPlnrDsnHk1NStructure : public JobPlnr {
...
// IP constructor --- BEGIN
	QryPlnrDsnHk1NStructure(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrDsnHk1NStructure();
