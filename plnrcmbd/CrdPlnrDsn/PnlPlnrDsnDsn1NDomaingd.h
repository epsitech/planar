/**
  * \file PnlPlnrDsnDsn1NDomaingd.h
  * job handler for job PnlPlnrDsnDsn1NDomaingd (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRDSNDSN1NDOMAINGD_H
#define PNLPLNRDSNDSN1NDOMAINGD_H
...
/**
  * PnlPlnrDsnDsn1NDomaingd
  */
class PnlPlnrDsnDsn1NDomaingd : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrDsnDsn1NDomaingdDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrDsnDsn1NDomaingd)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrDsnDsn1NDomaingd)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrDsnDsn1NDomaingd)
		*/
	...
	/**
		* StgIac (full: StgIacPlnrDsnDsn1NDomaingd)
		*/
	...
	/**
		* Tag (full: TagPlnrDsnDsn1NDomaingd)
		*/
	class Tag {
	...
	/**
		* DpchAppData (full: DpchAppPlnrDsnDsn1NDomaingdData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrDsnDsn1NDomaingdDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrDsnDsn1NDomaingdData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDsnDsn1NDomaingd* rst = NULL, QryPlnrDsnDsn1NDomaingd::StatShr* statshrqry = NULL, QryPlnrDsnDsn1NDomaingd::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrDsnDsn1NDomaingd::StatShr statshrqry;
		QryPlnrDsnDsn1NDomaingd::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlPlnrDsnDsn1NDomaingd(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDsnDsn1NDomaingd();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDsnDsn1NDomaingd::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
