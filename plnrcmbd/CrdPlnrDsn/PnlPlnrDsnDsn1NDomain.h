/**
  * \file PnlPlnrDsnDsn1NDomain.h
  * job handler for job PnlPlnrDsnDsn1NDomain (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRDSNDSN1NDOMAIN_H
#define PNLPLNRDSNDSN1NDOMAIN_H
...
/**
  * PnlPlnrDsnDsn1NDomain
  */
class PnlPlnrDsnDsn1NDomain : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrDsnDsn1NDomainDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrDsnDsn1NDomain)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrDsnDsn1NDomain)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrDsnDsn1NDomain)
		*/
	...
	/**
		* StgIac (full: StgIacPlnrDsnDsn1NDomain)
		*/
	...
	/**
		* Tag (full: TagPlnrDsnDsn1NDomain)
		*/
	class Tag {
	...
	/**
		* DpchAppData (full: DpchAppPlnrDsnDsn1NDomainData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrDsnDsn1NDomainDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrDsnDsn1NDomainData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDsnDsn1NDomain* rst = NULL, QryPlnrDsnDsn1NDomain::StatShr* statshrqry = NULL, QryPlnrDsnDsn1NDomain::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrDsnDsn1NDomain(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDsnDsn1NDomain();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDsnDsn1NDomain::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
