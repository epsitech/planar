/**
  * \file PnlPlnrDsnDsn1NStack.h
  * job handler for job PnlPlnrDsnDsn1NStack (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRDSNDSN1NSTACK_H
#define PNLPLNRDSNDSN1NSTACK_H
...
/**
  * PnlPlnrDsnDsn1NStack
  */
class PnlPlnrDsnDsn1NStack : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrDsnDsn1NStackDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrDsnDsn1NStack)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrDsnDsn1NStack)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrDsnDsn1NStack)
		*/
	...
	/**
		* StgIac (full: StgIacPlnrDsnDsn1NStack)
		*/
	...
	/**
		* DpchAppData (full: DpchAppPlnrDsnDsn1NStackData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrDsnDsn1NStackDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrDsnDsn1NStackData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDsnDsn1NStack* rst = NULL, QryPlnrDsnDsn1NStack::StatShr* statshrqry = NULL, QryPlnrDsnDsn1NStack::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrDsnDsn1NStack(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDsnDsn1NStack();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDsnDsn1NStack::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
