/**
  ...
  * job handler for job PnlPlnrDsnViewxy (declarations)
...
/**
  * PnlPlnrDsnViewxy
  */
class PnlPlnrDsnViewxy : public JobPlnr {
...
// IP constructor --- BEGIN
	PnlPlnrDsnViewxy(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDsnViewxy();
