/**
  ...
  * job handler for job PnlPlnrDsnHk1NArcguide (declarations)
...
/**
  ...
  */
class PnlPlnrDsnHk1NArcguide : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDsnHk1NArcguide* rst = NULL, QryPlnrDsnHk1NArcguide::StatShr* statshrqry = NULL, QryPlnrDsnHk1NArcguide::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrDsnHk1NArcguide(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDsnHk1NArcguide();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDsnHk1NArcguide::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
