/**
  * \file PnlPlnrUsgRec.h
  * job handler for job PnlPlnrUsgRec (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRUSGREC_H
#define PNLPLNRUSGREC_H
...
/**
  * PnlPlnrUsgRec
  */
class PnlPlnrUsgRec : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrUsgRecDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrUsgRec)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrUsgRec)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrUsgRec)
		*/
	...
	public:
		StatShr(const uint ixPlnrVExpstate = VecPlnrVExpstate::REGD, const ubigint jrefDetail = 0, const ubigint jrefAAccess = 0, const ubigint jrefMNUser = 0, const bool ButRegularizeActive = true);
	...
	/**
		* DpchAppDo (full: DpchAppPlnrUsgRecDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrUsgRecData)
		*/
...
// IP constructor --- BEGIN
	PnlPlnrUsgRec(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrUsgRec();
...
public:
	...
	PnlPlnrUsgDetail* pnldetail;
	PnlPlnrUsgAAccess* pnlaaccess;
	PnlPlnrUsgMNUser* pnlmnuser;
