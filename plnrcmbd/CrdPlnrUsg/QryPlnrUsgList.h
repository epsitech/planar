/**
  * \file QryPlnrUsgList.h
  * job handler for job QryPlnrUsgList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRUSGLIST_H
#define QRYPLNRUSGLIST_H
...
/**
  * QryPlnrUsgList
  */
class QryPlnrUsgList : public JobPlnr {

public:
	/**
		* VecVOrd (full: VecVQryPlnrUsgListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryPlnrUsgList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrUsgList)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrUsgList)
		*/
...
// IP constructor --- BEGIN
	QryPlnrUsgList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrUsgList();
...
public:
	...
	void refresh_filtSQL(string& sqlstr, const string& preSrf, const bool addwhere);
...
// IP handleCall --- END
	...
	bool handleCallPlnrUsgMod(DbsPlnr* dbsplnr, const ubigint jrefTrig);
