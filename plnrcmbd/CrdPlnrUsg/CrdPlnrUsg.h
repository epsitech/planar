/**
  * \file CrdPlnrUsg.h
  * job handler for job CrdPlnrUsg (declarations)
...
/**
  * CrdPlnrUsg
  */
class CrdPlnrUsg : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrUsgDo)
		*/
	class VecVDo {
	...
	/**
		* DpchAppDo (full: DpchAppPlnrUsgDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrUsgData)
		*/
...
public:
	CrdPlnrUsg(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0);
	~CrdPlnrUsg();
...
public:
	...
	PnlPlnrUsgRec* pnlrec;
	PnlPlnrUsgHeadbar* pnlheadbar;
	PnlPlnrUsgList* pnllist;
