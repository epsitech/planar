/**
  * \file PnlPlnrUsgAAccess.h
  * job handler for job PnlPlnrUsgAAccess (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRUSGAACCESS_H
#define PNLPLNRUSGAACCESS_H
...
/**
  * PnlPlnrUsgAAccess
  */
class PnlPlnrUsgAAccess : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrUsgAAccessDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrUsgAAccess)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrUsgAAccess)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrUsgAAccess)
		*/
	...
	/**
		* StgIac (full: StgIacPlnrUsgAAccess)
		*/
	...
	/**
		* DpchAppData (full: DpchAppPlnrUsgAAccessData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrUsgAAccessDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrUsgAAccessData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQUsgAAccess* rst = NULL, QryPlnrUsgAAccess::StatShr* statshrqry = NULL, QryPlnrUsgAAccess::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrUsgAAccess::StatShr statshrqry;
		QryPlnrUsgAAccess::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlPlnrUsgAAccess(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrUsgAAccess();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrUsgAAccess::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
