/**
  * \file VecPlnrVMimetype.cpp
  * vector VecPlnrVMimetype (implementation)
...
/******************************************************************************
 namespace VecPlnrVMimetype
 ******************************************************************************/

uint VecPlnrVMimetype::getIx(
			const string& sref
		) {
...
string VecPlnrVMimetype::getSref(
			const uint ix
		) {
...
string VecPlnrVMimetype::getTitle(
			const uint ix
		) {
