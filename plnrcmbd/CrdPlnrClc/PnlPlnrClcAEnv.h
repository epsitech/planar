/**
  * \file PnlPlnrClcAEnv.h
  * job handler for job PnlPlnrClcAEnv (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRCLCAENV_H
#define PNLPLNRCLCAENV_H
...
/**
  * PnlPlnrClcAEnv
  */
class PnlPlnrClcAEnv : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrClcAEnvDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrClcAEnv)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrClcAEnv)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrClcAEnv)
		*/
	...
	/**
		* DpchAppData (full: DpchAppPlnrClcAEnvData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrClcAEnvDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrClcAEnvData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQClcAEnv* rst = NULL, QryPlnrClcAEnv::StatShr* statshrqry = NULL, QryPlnrClcAEnv::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrClcAEnv(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrClcAEnv();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrClcAEnv::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
