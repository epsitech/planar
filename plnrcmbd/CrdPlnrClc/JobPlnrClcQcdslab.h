/**
  * \file JobPlnrClcQcdslab.h
  * job handler for job JobPlnrClcQcdslab (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef JOBPLNRCLCQCDSLAB_H
#define JOBPLNRCLCQCDSLAB_H
...
/**
  * JobPlnrClcQcdslab
  */
class JobPlnrClcQcdslab : public JobPlnr {

public:
	/**
		* VecVSge (full: VecVJobPlnrClcQcdslabSge)
		*/
	class VecVSge {
...
// IP constructor --- BEGIN
	JobPlnrClcQcdslab(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~JobPlnrClcQcdslab();
