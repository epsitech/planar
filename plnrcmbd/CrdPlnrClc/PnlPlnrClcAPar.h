/**
  * \file PnlPlnrClcAPar.h
  * job handler for job PnlPlnrClcAPar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRCLCAPAR_H
#define PNLPLNRCLCAPAR_H
...
/**
  * PnlPlnrClcAPar
  */
class PnlPlnrClcAPar : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrClcAParDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrClcAPar)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrClcAPar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrClcAPar)
		*/
	...
	/**
		* DpchAppData (full: DpchAppPlnrClcAParData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrClcAParDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrClcAParData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQClcAPar* rst = NULL, QryPlnrClcAPar::StatShr* statshrqry = NULL, QryPlnrClcAPar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrClcAPar::StatShr statshrqry;
		QryPlnrClcAPar::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlPlnrClcAPar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrClcAPar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrClcAPar::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
