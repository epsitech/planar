/**
  ...
  * job handler for job PnlPlnrClcView (declarations)
...
/**
  * PnlPlnrClcView
  */
class PnlPlnrClcView : public JobPlnr {
...
// IP constructor --- BEGIN
	PnlPlnrClcView(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrClcView();
