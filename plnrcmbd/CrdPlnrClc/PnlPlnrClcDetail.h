/**
  ...
  * job handler for job PnlPlnrClcDetail (declarations)
...
/**
  * PnlPlnrClcDetail
  */
class PnlPlnrClcDetail : public JobPlnr {
...
// IP constructor --- BEGIN
	PnlPlnrClcDetail(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrClcDetail();
