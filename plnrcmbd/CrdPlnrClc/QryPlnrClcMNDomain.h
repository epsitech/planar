/**
  ...
  * job handler for job QryPlnrClcMNDomain (declarations)
...
/**
  * QryPlnrClcMNDomain
  */
class QryPlnrClcMNDomain : public JobPlnr {
...
// IP constructor --- BEGIN
	QryPlnrClcMNDomain(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrClcMNDomain();
...
// IP handleCall --- END
	...
	bool handleCallPlnrCalRdomMod_calEq(DbsPlnr* dbsplnr, const ubigint jrefTrig, const ubigint refInv);
};
