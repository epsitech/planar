/**
  * \file JobPlnrClcQcdslab_blks.cpp
  * job handler for job JobPlnrClcQcdslab (implementation of blocks)
...
/******************************************************************************
 class JobPlnrClcQcdslab::VecVSge
 ******************************************************************************/

uint JobPlnrClcQcdslab::VecVSge::getIx(
			const string& sref
		) {
...
string JobPlnrClcQcdslab::VecVSge::getSref(
			const uint ix
		) {
...
void JobPlnrClcQcdslab::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
