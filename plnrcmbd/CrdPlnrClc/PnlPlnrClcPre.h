/**
  ...
  * job handler for job PnlPlnrClcPre (declarations)
...
/**
  * PnlPlnrClcPre
  */
class PnlPlnrClcPre : public JobPlnr {
...
// IP constructor --- BEGIN
	PnlPlnrClcPre(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrClcPre();
