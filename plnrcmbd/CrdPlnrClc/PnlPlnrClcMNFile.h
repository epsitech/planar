/**
  ...
  * job handler for job PnlPlnrClcMNFile (declarations)
...
/**
  * PnlPlnrClcMNFile
  */
class PnlPlnrClcMNFile : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQClcMNFile* rst = NULL, QryPlnrClcMNFile::StatShr* statshrqry = NULL, QryPlnrClcMNFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrClcMNFile(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrClcMNFile();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrClcMNFile::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
