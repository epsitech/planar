/**
  ...
  * job handler for job PnlPlnrClcRef1NFile (declarations)
...
/**
  * PnlPlnrClcRef1NFile
  */
class PnlPlnrClcRef1NFile : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQClcRef1NFile* rst = NULL, QryPlnrClcRef1NFile::StatShr* statshrqry = NULL, QryPlnrClcRef1NFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrClcRef1NFile(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrClcRef1NFile();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrClcRef1NFile::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
