/**
  ...
  * job handler for job PnlPlnrClcList (declarations)
...
/**
  * PnlPlnrClcList
  */
class PnlPlnrClcList : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQClcList* rst = NULL, QryPlnrClcList::StatShr* statshrqry = NULL, QryPlnrClcList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrClcList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrClcList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrClcList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
