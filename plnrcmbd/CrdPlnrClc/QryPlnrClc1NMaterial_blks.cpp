/**
  * \file QryPlnrClc1NMaterial_blks.cpp
  * job handler for job QryPlnrClc1NMaterial (implementation of blocks)
...
void QryPlnrClc1NMaterial::StatApp::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
			, const uint firstcol
	...
	if (difftag.length() == 0) difftag = "StatAppQryPlnrClc1NMaterial";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemAppQryPlnrClc1NMaterial";
...
void QryPlnrClc1NMaterial::StatShr::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StatShrQryPlnrClc1NMaterial";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StatitemShrQryPlnrClc1NMaterial";
