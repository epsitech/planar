/**
  * \file PnlPlnrDtpKParKey.h
  * job handler for job PnlPlnrDtpKParKey (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRDTPKPARKEY_H
#define PNLPLNRDTPKPARKEY_H
...
/**
  * PnlPlnrDtpKParKey
  */
class PnlPlnrDtpKParKey : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrDtpKParKeyDo)
		*/
	class VecVDo {
	...
	/**
	  * ContInf (full: ContInfPlnrDtpKParKey)
	  */
	...
	/**
		* StatApp (full: StatAppPlnrDtpKParKey)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrPlnrDtpKParKey)
		*/
	...
	/**
		* StgIac (full: StgIacPlnrDtpKParKey)
		*/
	...
	/**
		* DpchAppData (full: DpchAppPlnrDtpKParKeyData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrDtpKParKeyDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrDtpKParKeyData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDtpKParKey* rst = NULL, QryPlnrDtpKParKey::StatShr* statshrqry = NULL, QryPlnrDtpKParKey::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrDtpKParKey::StatShr statshrqry;
		QryPlnrDtpKParKey::StgIac stgiacqry;
...
// IP constructor --- BEGIN
	PnlPlnrDtpKParKey(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDtpKParKey();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDtpKParKey::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
