/**
  ...
  * job handler for job PnlPlnrDtpView (declarations)
...
/**
  * PnlPlnrDtpView
  */
class PnlPlnrDtpView : public JobPlnr {
...
// IP constructor --- BEGIN
	PnlPlnrDtpView(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDtpView();
