/**
  * \file QryPlnrDtpKParKey.h
  * job handler for job QryPlnrDtpKParKey (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRDTPKPARKEY_H
#define QRYPLNRDTPKPARKEY_H
...
/**
  * QryPlnrDtpKParKey
  */
class QryPlnrDtpKParKey : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrDtpKParKey)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrDtpKParKey)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrDtpKParKey)
		*/
...
// IP constructor --- BEGIN
	QryPlnrDtpKParKey(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrDtpKParKey();
