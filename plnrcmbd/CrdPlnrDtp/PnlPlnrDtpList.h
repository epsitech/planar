/**
  * \file PnlPlnrDtpList.h
  * job handler for job PnlPlnrDtpList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRDTPLIST_H
#define PNLPLNRDTPLIST_H
...
/**
  * PnlPlnrDtpList
  */
class PnlPlnrDtpList : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrDtpListDo)
		*/
	class VecVDo {
	...
	/**
	  * ContIac (full: ContIacPlnrDtpList)
	  */
	...
	/**
	  * ContInf (full: ContInfPlnrDtpList)
	  */
	...
	/**
		* StatShr (full: StatShrPlnrDtpList)
		*/
	...
	/**
		* StgIac (full: StgIacPlnrDtpList)
		*/
	class StgIac : public Block {

	public:
		static const uint TCOSRFWIDTH = 1;
		static const uint TCOSUPWIDTH = 2;

	public:
		StgIac(const uint TcoSrfWidth = 100, const uint TcoSupWidth = 100);
	...
	/**
		* DpchAppData (full: DpchAppPlnrDtpListData)
		*/
	...
	/**
		* DpchAppDo (full: DpchAppPlnrDtpListDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrDtpListData)
		*/
	...
	public:
		DpchEngData(const ubigint jref = 0, ContIac* contiac = NULL, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, Feed* feedFTos = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDtpList* rst = NULL, QryPlnrDtpList::StatShr* statshrqry = NULL, QryPlnrDtpList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrDtpList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDtpList();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDtpList::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
