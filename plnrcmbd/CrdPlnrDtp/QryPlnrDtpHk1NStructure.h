/**
  * \file QryPlnrDtpHk1NStructure.h
  * job handler for job QryPlnrDtpHk1NStructure (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRDTPHK1NSTRUCTURE_H
#define QRYPLNRDTPHK1NSTRUCTURE_H

// IP custInclude --- INSERT

/**
  * QryPlnrDtpHk1NStructure
  */
class QryPlnrDtpHk1NStructure : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrDtpHk1NStructure)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrDtpHk1NStructure)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrDtpHk1NStructure)
		*/
...
// IP constructor --- BEGIN
	QryPlnrDtpHk1NStructure(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrDtpHk1NStructure();
