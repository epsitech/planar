/**
  * \file QryPlnrDtpList.h
  * job handler for job QryPlnrDtpList (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRDTPLIST_H
#define QRYPLNRDTPLIST_H
...
/**
  * QryPlnrDtpList
  */
class QryPlnrDtpList : public JobPlnr {

public:
	/**
		* VecVOrd (full: VecVQryPlnrDtpListOrd)
		*/
	class VecVOrd {
	...
	/**
		* StatApp (full: StatAppQryPlnrDtpList)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrDtpList)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrDtpList)
		*/
...
// IP constructor --- BEGIN
	QryPlnrDtpList(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrDtpList();
