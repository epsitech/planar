/**
  ...
  * job handler for job PnlPlnrDtpAPar (declarations)
...
/**
  * PnlPlnrDtpAPar
  */
class PnlPlnrDtpAPar : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQDtpAPar* rst = NULL, QryPlnrDtpAPar::StatShr* statshrqry = NULL, QryPlnrDtpAPar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrDtpAPar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrDtpAPar();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrDtpAPar::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
