/**
  * \file QryPlnrDtpAPar.h
  * job handler for job QryPlnrDtpAPar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRDTPAPAR_H
#define QRYPLNRDTPAPAR_H
...
/**
  * QryPlnrDtpAPar
  */
class QryPlnrDtpAPar : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrDtpAPar)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrDtpAPar)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrDtpAPar)
		*/
...
// IP constructor --- BEGIN
	QryPlnrDtpAPar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrDtpAPar();
...
// IP handleCall --- END
	...
	bool handleCallPlnrDevAparMod_devEq(DbsPlnr* dbsplnr, const ubigint jrefTrig, const ubigint refInv);
};
