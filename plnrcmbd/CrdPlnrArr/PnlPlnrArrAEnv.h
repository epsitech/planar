/**
  ...
  * job handler for job PnlPlnrArrAEnv (declarations)
...
/**
  * PnlPlnrArrAEnv
  */
class PnlPlnrArrAEnv : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQArrAEnv* rst = NULL, QryPlnrArrAEnv::StatShr* statshrqry = NULL, QryPlnrArrAEnv::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrArrAEnv(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrArrAEnv();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrArrAEnv::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
