/**
  ...
  * job handler for job PnlPlnrArrKEnvKey (declarations)
...
/**
  * PnlPlnrArrKEnvKey
  */
class PnlPlnrArrKEnvKey : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQArrKEnvKey* rst = NULL, QryPlnrArrKEnvKey::StatShr* statshrqry = NULL, QryPlnrArrKEnvKey::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrArrKEnvKey(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrArrKEnvKey();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrArrKEnvKey::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
