/**
  * \file QryPlnrArrAEnv.h
  * job handler for job QryPlnrArrAEnv (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRARRAENV_H
#define QRYPLNRARRAENV_H
...
/**
  * QryPlnrArrAEnv
  */
class QryPlnrArrAEnv : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrArrAEnv)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrArrAEnv)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrArrAEnv)
		*/
...
// IP constructor --- BEGIN
	QryPlnrArrAEnv(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrArrAEnv();
...
// IP handleCall --- END
	...
	bool handleCallPlnrArrAenvMod_arrEq(DbsPlnr* dbsplnr, const ubigint jrefTrig, const ubigint refInv);
};
