/**
  ...
  * job handler for job PnlPlnrArr1NArrayitem (declarations)
...
/**
  ...
  */
class PnlPlnrArr1NArrayitem : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQArr1NArrayitem* rst = NULL, QryPlnrArr1NArrayitem::StatShr* statshrqry = NULL, QryPlnrArr1NArrayitem::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrArr1NArrayitem(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrArr1NArrayitem();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrArr1NArrayitem::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
