/**
  * \file CrdPlnrArr.h
  * job handler for job CrdPlnrArr (declarations)
...
/**
  * CrdPlnrArr
  */
class CrdPlnrArr : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrArrDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDARR = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdArr = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrArrDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrArrData)
		*/
...
public:
	CrdPlnrArr(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0, const uint ixPlnrVPreset = VecPlnrVPreset::VOID, const ubigint preUref = 0);
	~CrdPlnrArr();
...
public:
	...
	PnlPlnrArrRec* pnlrec;
	PnlPlnrArrHeadbar* pnlheadbar;
	PnlPlnrArrList* pnllist;
