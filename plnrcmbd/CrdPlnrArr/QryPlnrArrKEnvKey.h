/**
  * \file QryPlnrArrKEnvKey.h
  * job handler for job QryPlnrArrKEnvKey (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef QRYPLNRARRKENVKEY_H
#define QRYPLNRARRKENVKEY_H
...
/**
  * QryPlnrArrKEnvKey
  */
class QryPlnrArrKEnvKey : public JobPlnr {

public:
	/**
		* StatApp (full: StatAppQryPlnrArrKEnvKey)
		*/
	class StatApp {
	...
	/**
		* StatShr (full: StatShrQryPlnrArrKEnvKey)
		*/
	...
	/**
		* StgIac (full: StgIacQryPlnrArrKEnvKey)
		*/
...
// IP constructor --- BEGIN
	QryPlnrArrKEnvKey(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~QryPlnrArrKEnvKey();
