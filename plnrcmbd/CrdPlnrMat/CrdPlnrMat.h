/**
  * \file CrdPlnrMat.h
  * job handler for job CrdPlnrMat (declarations)
...
/**
  * CrdPlnrMat
  */
class CrdPlnrMat : public JobPlnr {

public:
	/**
		* VecVDo (full: VecVPlnrMatDo)
		*/
	class VecVDo {
	...
	public:
		...
		static const uint MTXCRDMAT = 3;

	public:
		ContInf(const uint numFSge = 1, const string& MrlAppHlp = "", const string& MtxCrdMat = "");
	...
	/**
		* DpchAppDo (full: DpchAppPlnrMatDo)
		*/
	...
	/**
		* DpchEngData (full: DpchEngPlnrMatData)
		*/
...
public:
	CrdPlnrMat(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale, const ubigint ref = 0);
	~CrdPlnrMat();
...
public:
	...
	PnlPlnrMatRec* pnlrec;
	PnlPlnrMatHeadbar* pnlheadbar;
	PnlPlnrMatList* pnllist;
