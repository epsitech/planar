/**
  * \file JobPlnrTpoUvslides_blks.cpp
  * job handler for job JobPlnrTpoUvslides (implementation of blocks)
...
/******************************************************************************
 class JobPlnrTpoUvslides::VecVSge
 ******************************************************************************/

uint JobPlnrTpoUvslides::VecVSge::getIx(
			const string& sref
		) {
...
string JobPlnrTpoUvslides::VecVSge::getSref(
			const uint ix
		) {
...
void JobPlnrTpoUvslides::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
