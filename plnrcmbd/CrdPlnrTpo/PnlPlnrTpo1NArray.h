/**
  ...
  * job handler for job PnlPlnrTpo1NArray (declarations)
...
/**
  * PnlPlnrTpo1NArray
  */
class PnlPlnrTpo1NArray : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQTpo1NArray* rst = NULL, QryPlnrTpo1NArray::StatShr* statshrqry = NULL, QryPlnrTpo1NArray::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrTpo1NArray(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrTpo1NArray();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrTpo1NArray::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
