/**
  ...
  * job handler for job PnlPlnrTpoHk1NReticle (declarations)
...
/**
  ...
  */
class PnlPlnrTpoHk1NReticle : public JobPlnr {
...
public:
	...
	public:
		DpchEngData(const ubigint jref = 0, ContInf* continf = NULL, Feed* feedFCsiQst = NULL, StatShr* statshr = NULL, StgIac* stgiac = NULL, ListPlnrQTpoHk1NReticle* rst = NULL, QryPlnrTpoHk1NReticle::StatShr* statshrqry = NULL, QryPlnrTpoHk1NReticle::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
...
// IP constructor --- BEGIN
	PnlPlnrTpoHk1NReticle(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrTpoHk1NReticle();
...
public:
	...
	void handleDpchAppDataStgiacqry(DbsPlnr* dbsplnr, QryPlnrTpoHk1NReticle::StgIac* _stgiacqry, DpchEngPlnr** dpcheng);
