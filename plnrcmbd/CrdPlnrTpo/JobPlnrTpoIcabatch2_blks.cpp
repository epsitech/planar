/**
  * \file JobPlnrTpoIcabatch2_blks.cpp
  * job handler for job JobPlnrTpoIcabatch2 (implementation of blocks)
...
/******************************************************************************
 class JobPlnrTpoIcabatch2::VecVSge
 ******************************************************************************/

uint JobPlnrTpoIcabatch2::VecVSge::getIx(
			const string& sref
		) {
...
string JobPlnrTpoIcabatch2::VecVSge::getSref(
			const uint ix
		) {
...
void JobPlnrTpoIcabatch2::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
