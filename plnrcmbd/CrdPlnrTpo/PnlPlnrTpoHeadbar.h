/**
  ...
  * job handler for job PnlPlnrTpoHeadbar (declarations)
...
/**
  * PnlPlnrTpoHeadbar
  */
class PnlPlnrTpoHeadbar : public JobPlnr {
...
// IP constructor --- BEGIN
	PnlPlnrTpoHeadbar(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrTpoHeadbar();
