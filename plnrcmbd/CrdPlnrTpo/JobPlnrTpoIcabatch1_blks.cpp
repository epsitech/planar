/**
  * \file JobPlnrTpoIcabatch1_blks.cpp
  * job handler for job JobPlnrTpoIcabatch1 (implementation of blocks)
...
/******************************************************************************
 class JobPlnrTpoIcabatch1::VecVSge
 ******************************************************************************/

uint JobPlnrTpoIcabatch1::VecVSge::getIx(
			const string& sref
		) {
...
string JobPlnrTpoIcabatch1::VecVSge::getSref(
			const uint ix
		) {
...
void JobPlnrTpoIcabatch1::VecVSge::fillFeed(
			Feed& feed
		) {
	feed.clear();
