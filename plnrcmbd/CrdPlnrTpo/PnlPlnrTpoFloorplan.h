/**
  ...
  * job handler for job PnlPlnrTpoFloorplan (declarations)
...
/**
  * PnlPlnrTpoFloorplan
  */
class PnlPlnrTpoFloorplan : public JobPlnr {
...
// IP constructor --- BEGIN
	PnlPlnrTpoFloorplan(XchgPlnr* xchg, DbsPlnr* dbsplnr, const ubigint jrefSup, const uint ixPlnrVLocale);
// IP constructor --- END
	~PnlPlnrTpoFloorplan();
