/**
  ...
  * app access code for job PnlPlnrClcCal1NCalcitem (declarations)
...
/**
  ...
  */
namespace PnlPlnrClcCal1NCalcitem {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrClcCal1NCalcitem::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrClcCal1NCalcitem::StatApp statappqry;
