/**
  ...
  * app access code for job QryPlnrDomMNCalc (implementation)
...
/******************************************************************************
 class QryPlnrDomMNCalc::StatApp
 ******************************************************************************/

QryPlnrDomMNCalc::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrDomMNCalc::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrDomMNCalc");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrDomMNCalc";
...
set<uint> QryPlnrDomMNCalc::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDomMNCalc::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDomMNCalc::StatShr
 ******************************************************************************/

QryPlnrDomMNCalc::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrDomMNCalc::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrDomMNCalc");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrDomMNCalc";
...
set<uint> QryPlnrDomMNCalc::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDomMNCalc::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDomMNCalc::StgIac
 ******************************************************************************/

QryPlnrDomMNCalc::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrDomMNCalc::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrDomMNCalc");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrDomMNCalc";
...
void QryPlnrDomMNCalc::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrDomMNCalc";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrDomMNCalc";
...
set<uint> QryPlnrDomMNCalc::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDomMNCalc::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
