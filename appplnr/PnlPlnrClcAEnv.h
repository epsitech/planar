/**
  ...
  * app access code for job PnlPlnrClcAEnv (declarations)
...
namespace PnlPlnrClcAEnv {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrClcAEnv::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrClcAEnv::StatApp statappqry;
