/**
  ...
  * app access code for job PnlPlnrLyr1NBlock (declarations)
...
namespace PnlPlnrLyr1NBlock {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrLyr1NBlock::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrLyr1NBlock::StatApp statappqry;
