/**
  ...
  * app access code for job PnlPlnrDtpKParKey (declarations)
...
namespace PnlPlnrDtpKParKey {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrDtpKParKey::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrDtpKParKey::StatApp statappqry;
