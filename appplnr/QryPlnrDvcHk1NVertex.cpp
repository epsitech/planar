/**
  ...
  * app access code for job QryPlnrDvcHk1NVertex (implementation)
...
/******************************************************************************
 class QryPlnrDvcHk1NVertex::StatApp
 ******************************************************************************/

QryPlnrDvcHk1NVertex::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrDvcHk1NVertex::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrDvcHk1NVertex");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrDvcHk1NVertex";
...
set<uint> QryPlnrDvcHk1NVertex::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDvcHk1NVertex::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDvcHk1NVertex::StatShr
 ******************************************************************************/

QryPlnrDvcHk1NVertex::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrDvcHk1NVertex::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrDvcHk1NVertex");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrDvcHk1NVertex";
...
set<uint> QryPlnrDvcHk1NVertex::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDvcHk1NVertex::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDvcHk1NVertex::StgIac
 ******************************************************************************/

QryPlnrDvcHk1NVertex::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrDvcHk1NVertex::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrDvcHk1NVertex");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrDvcHk1NVertex";
...
void QryPlnrDvcHk1NVertex::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrDvcHk1NVertex";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrDvcHk1NVertex";
...
set<uint> QryPlnrDvcHk1NVertex::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDvcHk1NVertex::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
