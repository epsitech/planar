/**
  ...
  * app access code for job PnlPlnrCtpAPar (declarations)
...
namespace PnlPlnrCtpAPar {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrCtpAPar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrCtpAPar::StatApp statappqry;
