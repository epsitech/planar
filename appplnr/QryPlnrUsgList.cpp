/**
  ...
  * app access code for job QryPlnrUsgList (implementation)
...
/******************************************************************************
 class QryPlnrUsgList::VecVOrd
 ******************************************************************************/

uint QryPlnrUsgList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryPlnrUsgList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryPlnrUsgList::StatApp
 ******************************************************************************/

QryPlnrUsgList::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrUsgList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrUsgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrUsgList";
...
set<uint> QryPlnrUsgList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrUsgList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrUsgList::StatShr
 ******************************************************************************/

QryPlnrUsgList::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrUsgList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrUsgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrUsgList";
...
set<uint> QryPlnrUsgList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrUsgList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrUsgList::StgIac
 ******************************************************************************/

QryPlnrUsgList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrUsgList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrUsgList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrUsgList";
...
void QryPlnrUsgList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrUsgList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrUsgList";
...
set<uint> QryPlnrUsgList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrUsgList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
