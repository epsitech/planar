/**
  ...
  * app access code for job QryPlnrTpo1NArray (implementation)
...
/******************************************************************************
 class QryPlnrTpo1NArray::StatApp
 ******************************************************************************/

QryPlnrTpo1NArray::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrTpo1NArray::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrTpo1NArray");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrTpo1NArray";
...
set<uint> QryPlnrTpo1NArray::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpo1NArray::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrTpo1NArray::StatShr
 ******************************************************************************/

QryPlnrTpo1NArray::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrTpo1NArray::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrTpo1NArray");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrTpo1NArray";
...
set<uint> QryPlnrTpo1NArray::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpo1NArray::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrTpo1NArray::StgIac
 ******************************************************************************/

QryPlnrTpo1NArray::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrTpo1NArray::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrTpo1NArray");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrTpo1NArray";
...
void QryPlnrTpo1NArray::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrTpo1NArray";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrTpo1NArray";
...
set<uint> QryPlnrTpo1NArray::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpo1NArray::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
