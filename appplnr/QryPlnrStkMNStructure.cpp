/**
  ...
  * app access code for job QryPlnrStkMNStructure (implementation)
...
/******************************************************************************
 class QryPlnrStkMNStructure::StatApp
 ******************************************************************************/

QryPlnrStkMNStructure::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrStkMNStructure::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrStkMNStructure");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrStkMNStructure";
...
set<uint> QryPlnrStkMNStructure::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrStkMNStructure::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrStkMNStructure::StatShr
 ******************************************************************************/

QryPlnrStkMNStructure::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrStkMNStructure::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrStkMNStructure");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrStkMNStructure";
...
set<uint> QryPlnrStkMNStructure::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrStkMNStructure::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrStkMNStructure::StgIac
 ******************************************************************************/

QryPlnrStkMNStructure::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrStkMNStructure::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrStkMNStructure");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrStkMNStructure";
...
void QryPlnrStkMNStructure::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrStkMNStructure";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrStkMNStructure";
...
set<uint> QryPlnrStkMNStructure::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrStkMNStructure::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
