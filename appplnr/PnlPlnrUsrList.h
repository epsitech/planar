/**
  ...
  * app access code for job PnlPlnrUsrList (declarations)
...
namespace PnlPlnrUsrList {
	...
	public:
		DpchAppData(const string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryPlnrUsrList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrUsrList::StatApp statappqry;
