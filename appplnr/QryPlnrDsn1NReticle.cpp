/**
  ...
  * app access code for job QryPlnrDsn1NReticle (implementation)
...
/******************************************************************************
 class QryPlnrDsn1NReticle::StatApp
 ******************************************************************************/

QryPlnrDsn1NReticle::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrDsn1NReticle::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrDsn1NReticle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrDsn1NReticle";
...
set<uint> QryPlnrDsn1NReticle::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDsn1NReticle::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDsn1NReticle::StatShr
 ******************************************************************************/

QryPlnrDsn1NReticle::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrDsn1NReticle::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrDsn1NReticle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrDsn1NReticle";
...
set<uint> QryPlnrDsn1NReticle::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDsn1NReticle::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDsn1NReticle::StgIac
 ******************************************************************************/

QryPlnrDsn1NReticle::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrDsn1NReticle::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrDsn1NReticle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrDsn1NReticle";
...
void QryPlnrDsn1NReticle::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrDsn1NReticle";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrDsn1NReticle";
...
set<uint> QryPlnrDsn1NReticle::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDsn1NReticle::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
