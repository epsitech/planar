/**
  ...
  * app access code for job QryPlnrSruSru1NFace (implementation)
...
/******************************************************************************
 class QryPlnrSruSru1NFace::StatApp
 ******************************************************************************/

QryPlnrSruSru1NFace::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrSruSru1NFace::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrSruSru1NFace");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrSruSru1NFace";
...
set<uint> QryPlnrSruSru1NFace::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrSruSru1NFace::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrSruSru1NFace::StatShr
 ******************************************************************************/

QryPlnrSruSru1NFace::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrSruSru1NFace::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrSruSru1NFace");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrSruSru1NFace";
...
set<uint> QryPlnrSruSru1NFace::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrSruSru1NFace::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrSruSru1NFace::StgIac
 ******************************************************************************/

QryPlnrSruSru1NFace::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrSruSru1NFace::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrSruSru1NFace");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrSruSru1NFace";
...
void QryPlnrSruSru1NFace::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrSruSru1NFace";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrSruSru1NFace";
...
set<uint> QryPlnrSruSru1NFace::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrSruSru1NFace::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
