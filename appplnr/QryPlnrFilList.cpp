/**
  ...
  * app access code for job QryPlnrFilList (implementation)
...
/******************************************************************************
 class QryPlnrFilList::VecVOrd
 ******************************************************************************/

uint QryPlnrFilList::VecVOrd::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);

	if (s.compare("fnm") == 0) return FNM;
	else if (s.compare("ret") == 0) return RET;
	else if (s.compare("reu") == 0) return REU;

	return(0);
};

string QryPlnrFilList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryPlnrFilList::StatApp
 ******************************************************************************/

QryPlnrFilList::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrFilList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrFilList";
...
set<uint> QryPlnrFilList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrFilList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrFilList::StatShr
 ******************************************************************************/

QryPlnrFilList::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrFilList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrFilList";
...
set<uint> QryPlnrFilList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrFilList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrFilList::StgIac
 ******************************************************************************/

QryPlnrFilList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrFilList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrFilList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrFilList";
...
void QryPlnrFilList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrFilList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrFilList";
...
set<uint> QryPlnrFilList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrFilList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
