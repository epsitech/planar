/**
  ...
  * app access code for job PnlPlnrDsnDsn1NDomain (declarations)
...
/**
  ...
  */
namespace PnlPlnrDsnDsn1NDomain {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrDsnDsn1NDomain::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrDsnDsn1NDomain::StatApp statappqry;
