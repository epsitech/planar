/**
  ...
  * app access code for job QryPlnrCliAAMCalcEnv (implementation)
...
/******************************************************************************
 class QryPlnrCliAAMCalcEnv::StatApp
 ******************************************************************************/

QryPlnrCliAAMCalcEnv::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrCliAAMCalcEnv::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrCliAAMCalcEnv");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrCliAAMCalcEnv";
...
set<uint> QryPlnrCliAAMCalcEnv::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrCliAAMCalcEnv::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrCliAAMCalcEnv::StatShr
 ******************************************************************************/

QryPlnrCliAAMCalcEnv::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrCliAAMCalcEnv::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrCliAAMCalcEnv");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrCliAAMCalcEnv";
...
set<uint> QryPlnrCliAAMCalcEnv::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrCliAAMCalcEnv::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrCliAAMCalcEnv::StgIac
 ******************************************************************************/

QryPlnrCliAAMCalcEnv::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrCliAAMCalcEnv::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrCliAAMCalcEnv");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrCliAAMCalcEnv";
...
void QryPlnrCliAAMCalcEnv::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrCliAAMCalcEnv";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrCliAAMCalcEnv";
...
set<uint> QryPlnrCliAAMCalcEnv::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrCliAAMCalcEnv::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
