/**
  ...
  * app access code for job PnlPlnrDsnDsn1NDomaingd (declarations)
...
/**
  ...
  */
namespace PnlPlnrDsnDsn1NDomaingd {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrDsnDsn1NDomaingd::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrDsnDsn1NDomaingd::StatApp statappqry;
