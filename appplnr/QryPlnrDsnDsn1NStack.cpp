/**
  ...
  * app access code for job QryPlnrDsnDsn1NStack (implementation)
...
/******************************************************************************
 class QryPlnrDsnDsn1NStack::StatApp
 ******************************************************************************/

QryPlnrDsnDsn1NStack::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrDsnDsn1NStack::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrDsnDsn1NStack");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrDsnDsn1NStack";
...
set<uint> QryPlnrDsnDsn1NStack::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDsnDsn1NStack::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDsnDsn1NStack::StatShr
 ******************************************************************************/

QryPlnrDsnDsn1NStack::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrDsnDsn1NStack::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrDsnDsn1NStack");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrDsnDsn1NStack";
...
set<uint> QryPlnrDsnDsn1NStack::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDsnDsn1NStack::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDsnDsn1NStack::StgIac
 ******************************************************************************/

QryPlnrDsnDsn1NStack::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrDsnDsn1NStack::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrDsnDsn1NStack");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrDsnDsn1NStack";
...
void QryPlnrDsnDsn1NStack::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrDsnDsn1NStack";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrDsnDsn1NStack";
...
set<uint> QryPlnrDsnDsn1NStack::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDsnDsn1NStack::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
