/**
  ...
  * app access code for job PnlPlnrDsnHk1NLevel (declarations)
...
namespace PnlPlnrDsnHk1NLevel {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrDsnHk1NLevel::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrDsnHk1NLevel::StatApp statappqry;
