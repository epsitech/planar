/**
  ...
  * app access code for job QryPlnrCliAAMCalcPar (implementation)
...
/******************************************************************************
 class QryPlnrCliAAMCalcPar::StatApp
 ******************************************************************************/

QryPlnrCliAAMCalcPar::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrCliAAMCalcPar::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrCliAAMCalcPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrCliAAMCalcPar";
...
set<uint> QryPlnrCliAAMCalcPar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrCliAAMCalcPar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrCliAAMCalcPar::StatShr
 ******************************************************************************/

QryPlnrCliAAMCalcPar::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrCliAAMCalcPar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrCliAAMCalcPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrCliAAMCalcPar";
...
set<uint> QryPlnrCliAAMCalcPar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrCliAAMCalcPar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrCliAAMCalcPar::StgIac
 ******************************************************************************/

QryPlnrCliAAMCalcPar::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrCliAAMCalcPar::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrCliAAMCalcPar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrCliAAMCalcPar";
...
void QryPlnrCliAAMCalcPar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrCliAAMCalcPar";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrCliAAMCalcPar";
...
set<uint> QryPlnrCliAAMCalcPar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrCliAAMCalcPar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
