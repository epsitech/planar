/**
  ...
  * app access code for job QryPlnrDvcList (implementation)
...
/******************************************************************************
 class QryPlnrDvcList::VecVOrd
 ******************************************************************************/

uint QryPlnrDvcList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryPlnrDvcList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryPlnrDvcList::StatApp
 ******************************************************************************/

QryPlnrDvcList::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrDvcList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrDvcList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrDvcList";
...
set<uint> QryPlnrDvcList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDvcList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDvcList::StatShr
 ******************************************************************************/

QryPlnrDvcList::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrDvcList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrDvcList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrDvcList";
...
set<uint> QryPlnrDvcList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDvcList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDvcList::StgIac
 ******************************************************************************/

QryPlnrDvcList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrDvcList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrDvcList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrDvcList";
...
void QryPlnrDvcList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrDvcList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrDvcList";
...
set<uint> QryPlnrDvcList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDvcList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
