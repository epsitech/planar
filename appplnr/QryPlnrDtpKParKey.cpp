/**
  ...
  * app access code for job QryPlnrDtpKParKey (implementation)
...
/******************************************************************************
 class QryPlnrDtpKParKey::StatApp
 ******************************************************************************/

QryPlnrDtpKParKey::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrDtpKParKey::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrDtpKParKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrDtpKParKey";
...
set<uint> QryPlnrDtpKParKey::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDtpKParKey::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDtpKParKey::StatShr
 ******************************************************************************/

QryPlnrDtpKParKey::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrDtpKParKey::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrDtpKParKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrDtpKParKey";
...
set<uint> QryPlnrDtpKParKey::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDtpKParKey::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDtpKParKey::StgIac
 ******************************************************************************/

QryPlnrDtpKParKey::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrDtpKParKey::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrDtpKParKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrDtpKParKey";
...
set<uint> QryPlnrDtpKParKey::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDtpKParKey::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
