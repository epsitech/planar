/**
  ...
  * app access code for job PnlPlnrCliList (declarations)
...
namespace PnlPlnrCliList {
	...
	public:
		...
		static const uint TCOCAL = 7;
		static const uint TCODSN = 8;

	public:
		Tag(const string& Cpt = "", const string& TxtFor = "", const string& Trs = "", const string& TxtShowing1 = "", const string& TxtShowing2 = "", const string& TcoTit = "", const string& TcoCal = "", const string& TcoDsn = "");
	...
	public:
		DpchAppData(const string& scrJref = "", ContIac* contiac = NULL, StgIac* stgiac = NULL, QryPlnrCliList::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrCliList::StatApp statappqry;
