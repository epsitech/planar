/**
  ...
  * app access code for job PnlPlnrClcAPar (declarations)
...
namespace PnlPlnrClcAPar {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrClcAPar::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrClcAPar::StatApp statappqry;
