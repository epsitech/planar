/**
  ...
  * app access code for job PnlPlnrDtpHk1NStructure (declarations)
...
/**
  ...
  */
namespace PnlPlnrDtpHk1NStructure {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrDtpHk1NStructure::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrDtpHk1NStructure::StatApp statappqry;
