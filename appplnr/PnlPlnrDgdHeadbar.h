/**
  * \file PnlPlnrDgdHeadbar.h
  * app access code for job PnlPlnrDgdHeadbar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRDGDHEADBAR_H
#define PNLPLNRDGDHEADBAR_H
...
/**
  * PnlPlnrDgdHeadbar
  */
namespace PnlPlnrDgdHeadbar {
	/**
	  * StgInf (full: StgInfPlnrDgdHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngPlnrDgdHeadbarData)
		*/
