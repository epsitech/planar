/**
  ...
  * app access code for job PnlPlnrCliRef1NFile (declarations)
...
namespace PnlPlnrCliRef1NFile {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrCliRef1NFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrCliRef1NFile::StatApp statappqry;
