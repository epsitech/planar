/**
  * \file CrdPlnrUsr.cpp
  * app access code for job CrdPlnrUsr (implementation)
...
/******************************************************************************
 class CrdPlnrUsr::VecVDo
 ******************************************************************************/

uint CrdPlnrUsr::VecVDo::getIx(
			const string& sref
		) {
...
string CrdPlnrUsr::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrUsr::VecVSge
 ******************************************************************************/

uint CrdPlnrUsr::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdPlnrUsr::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrUsr::ContInf
 ******************************************************************************/

CrdPlnrUsr::ContInf::ContInf(
			const uint numFSge
...
bool CrdPlnrUsr::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfPlnrUsr");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfPlnrUsr";
...
set<uint> CrdPlnrUsr::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
	...
	if (MtxCrdUsr.compare(comp->MtxCrdUsr) == 0) insert(items, MTXCRDUSR);

	return(items);
};

set<uint> CrdPlnrUsr::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdPlnrUsr::StatApp
 ******************************************************************************/

CrdPlnrUsr::StatApp::StatApp(
...
bool CrdPlnrUsr::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppPlnrUsr");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppPlnrUsr";
...
set<uint> CrdPlnrUsr::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrUsr::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdPlnrUsr::StatShr
 ******************************************************************************/

CrdPlnrUsr::StatShr::StatShr(
...
bool CrdPlnrUsr::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrPlnrUsr");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrPlnrUsr";
...
set<uint> CrdPlnrUsr::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrUsr::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdPlnrUsr::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagPlnrUsr");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemPlnrUsr";
...
/******************************************************************************
 class CrdPlnrUsr::DpchAppDo
 ******************************************************************************/

CrdPlnrUsr::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppPlnr(VecPlnrVDpch::DPCHAPPPLNRUSRDO, scrJref) {
...
void CrdPlnrUsr::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppPlnrUsrDo");
...
/******************************************************************************
 class CrdPlnrUsr::DpchEngData
 ******************************************************************************/

CrdPlnrUsr::DpchEngData::DpchEngData() : DpchEngPlnr(VecPlnrVDpch::DPCHENGPLNRUSRDATA) {
	feedFSge.tag = "FeedFSge";
};

void CrdPlnrUsr::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngPlnrUsrData");
	else
		basefound = checkXPath(docctx, basexpath);
