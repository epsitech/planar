/**
  ...
  * app access code for job QryPlnrPrjMNTapeout (implementation)
...
/******************************************************************************
 class QryPlnrPrjMNTapeout::StatApp
 ******************************************************************************/

QryPlnrPrjMNTapeout::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrPrjMNTapeout::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrPrjMNTapeout");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrPrjMNTapeout";
...
set<uint> QryPlnrPrjMNTapeout::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrPrjMNTapeout::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrPrjMNTapeout::StatShr
 ******************************************************************************/

QryPlnrPrjMNTapeout::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrPrjMNTapeout::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrPrjMNTapeout");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrPrjMNTapeout";
...
set<uint> QryPlnrPrjMNTapeout::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrPrjMNTapeout::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrPrjMNTapeout::StgIac
 ******************************************************************************/

QryPlnrPrjMNTapeout::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrPrjMNTapeout::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrPrjMNTapeout");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrPrjMNTapeout";
...
void QryPlnrPrjMNTapeout::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrPrjMNTapeout";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrPrjMNTapeout";
...
set<uint> QryPlnrPrjMNTapeout::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrPrjMNTapeout::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
