/**
  * \file PnlPlnrSruHeadbar.h
  * app access code for job PnlPlnrSruHeadbar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRSRUHEADBAR_H
#define PNLPLNRSRUHEADBAR_H
...
/**
  * PnlPlnrSruHeadbar
  */
namespace PnlPlnrSruHeadbar {
	/**
	  * StgInf (full: StgInfPlnrSruHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngPlnrSruHeadbarData)
		*/
