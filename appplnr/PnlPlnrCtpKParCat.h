/**
  ...
  * app access code for job PnlPlnrCtpKParCat (declarations)
...
namespace PnlPlnrCtpKParCat {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrCtpKParCat::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrCtpKParCat::StatApp statappqry;
