/**
  ...
  * app access code for job QryPlnrArrKEnvKey (implementation)
...
/******************************************************************************
 class QryPlnrArrKEnvKey::StatApp
 ******************************************************************************/

QryPlnrArrKEnvKey::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrArrKEnvKey::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrArrKEnvKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrArrKEnvKey";
...
set<uint> QryPlnrArrKEnvKey::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrArrKEnvKey::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrArrKEnvKey::StatShr
 ******************************************************************************/

QryPlnrArrKEnvKey::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrArrKEnvKey::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrArrKEnvKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrArrKEnvKey";
...
set<uint> QryPlnrArrKEnvKey::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrArrKEnvKey::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrArrKEnvKey::StgIac
 ******************************************************************************/

QryPlnrArrKEnvKey::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrArrKEnvKey::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrArrKEnvKey");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrArrKEnvKey";
...
void QryPlnrArrKEnvKey::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrArrKEnvKey";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrArrKEnvKey";
...
set<uint> QryPlnrArrKEnvKey::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrArrKEnvKey::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
