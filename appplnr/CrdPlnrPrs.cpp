/**
  * \file CrdPlnrPrs.cpp
  * app access code for job CrdPlnrPrs (implementation)
...
/******************************************************************************
 class CrdPlnrPrs::VecVDo
 ******************************************************************************/

uint CrdPlnrPrs::VecVDo::getIx(
			const string& sref
		) {
...
string CrdPlnrPrs::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrPrs::VecVSge
 ******************************************************************************/

uint CrdPlnrPrs::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdPlnrPrs::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrPrs::ContInf
 ******************************************************************************/

CrdPlnrPrs::ContInf::ContInf(
			const uint numFSge
...
bool CrdPlnrPrs::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfPlnrPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfPlnrPrs";
...
set<uint> CrdPlnrPrs::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
	...
	if (MtxCrdPrs.compare(comp->MtxCrdPrs) == 0) insert(items, MTXCRDPRS);

	return(items);
};

set<uint> CrdPlnrPrs::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdPlnrPrs::StatApp
 ******************************************************************************/

CrdPlnrPrs::StatApp::StatApp(
...
bool CrdPlnrPrs::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppPlnrPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppPlnrPrs";
...
set<uint> CrdPlnrPrs::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrPrs::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdPlnrPrs::StatShr
 ******************************************************************************/

CrdPlnrPrs::StatShr::StatShr(
...
bool CrdPlnrPrs::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrPlnrPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrPlnrPrs";
...
set<uint> CrdPlnrPrs::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrPrs::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdPlnrPrs::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagPlnrPrs");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemPlnrPrs";
...
/******************************************************************************
 class CrdPlnrPrs::DpchAppDo
 ******************************************************************************/

CrdPlnrPrs::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppPlnr(VecPlnrVDpch::DPCHAPPPLNRPRSDO, scrJref) {
...
void CrdPlnrPrs::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppPlnrPrsDo");
...
/******************************************************************************
 class CrdPlnrPrs::DpchEngData
 ******************************************************************************/

CrdPlnrPrs::DpchEngData::DpchEngData() : DpchEngPlnr(VecPlnrVDpch::DPCHENGPLNRPRSDATA) {
	feedFSge.tag = "FeedFSge";
};

void CrdPlnrPrs::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngPlnrPrsData");
	else
		basefound = checkXPath(docctx, basexpath);
