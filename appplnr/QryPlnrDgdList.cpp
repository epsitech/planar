/**
  ...
  * app access code for job QryPlnrDgdList (implementation)
...
/******************************************************************************
 class QryPlnrDgdList::VecVOrd
 ******************************************************************************/

uint QryPlnrDgdList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryPlnrDgdList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryPlnrDgdList::StatApp
 ******************************************************************************/

QryPlnrDgdList::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrDgdList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrDgdList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrDgdList";
...
set<uint> QryPlnrDgdList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDgdList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDgdList::StatShr
 ******************************************************************************/

QryPlnrDgdList::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrDgdList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrDgdList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrDgdList";
...
set<uint> QryPlnrDgdList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDgdList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDgdList::StgIac
 ******************************************************************************/

QryPlnrDgdList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrDgdList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrDgdList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrDgdList";
...
void QryPlnrDgdList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrDgdList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrDgdList";
...
set<uint> QryPlnrDgdList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDgdList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
