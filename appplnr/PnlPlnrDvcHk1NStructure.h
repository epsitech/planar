/**
  ...
  * app access code for job PnlPlnrDvcHk1NStructure (declarations)
...
/**
  ...
  */
namespace PnlPlnrDvcHk1NStructure {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrDvcHk1NStructure::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrDvcHk1NStructure::StatApp statappqry;
