/**
  ...
  * app access code for job PnlPlnrMatRef1NFile (declarations)
...
namespace PnlPlnrMatRef1NFile {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrMatRef1NFile::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrMatRef1NFile::StatApp statappqry;
