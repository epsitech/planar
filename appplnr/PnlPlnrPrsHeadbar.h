/**
  * \file PnlPlnrPrsHeadbar.h
  * app access code for job PnlPlnrPrsHeadbar (declarations)
  * \author Alexander Wirthmueller
  * \date created: 4 Dec 2015
  * \date modified: 4 Dec 2015
  */

#ifndef PNLPLNRPRSHEADBAR_H
#define PNLPLNRPRSHEADBAR_H
...
/**
  * PnlPlnrPrsHeadbar
  */
namespace PnlPlnrPrsHeadbar {
	/**
	  * StgInf (full: StgInfPlnrPrsHeadbar)
	  */
	...
	/**
		* DpchEngData (full: DpchEngPlnrPrsHeadbarData)
		*/
