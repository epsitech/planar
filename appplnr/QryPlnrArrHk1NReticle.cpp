/**
  ...
  * app access code for job QryPlnrArrHk1NReticle (implementation)
...
/******************************************************************************
 class QryPlnrArrHk1NReticle::StatApp
 ******************************************************************************/

QryPlnrArrHk1NReticle::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrArrHk1NReticle::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrArrHk1NReticle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrArrHk1NReticle";
...
set<uint> QryPlnrArrHk1NReticle::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrArrHk1NReticle::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrArrHk1NReticle::StatShr
 ******************************************************************************/

QryPlnrArrHk1NReticle::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrArrHk1NReticle::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrArrHk1NReticle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrArrHk1NReticle";
...
set<uint> QryPlnrArrHk1NReticle::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrArrHk1NReticle::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrArrHk1NReticle::StgIac
 ******************************************************************************/

QryPlnrArrHk1NReticle::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrArrHk1NReticle::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrArrHk1NReticle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrArrHk1NReticle";
...
void QryPlnrArrHk1NReticle::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrArrHk1NReticle";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrArrHk1NReticle";
...
set<uint> QryPlnrArrHk1NReticle::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrArrHk1NReticle::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
