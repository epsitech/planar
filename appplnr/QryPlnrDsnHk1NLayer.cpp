/**
  ...
  * app access code for job QryPlnrDsnHk1NLayer (implementation)
...
/******************************************************************************
 class QryPlnrDsnHk1NLayer::StatApp
 ******************************************************************************/

QryPlnrDsnHk1NLayer::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrDsnHk1NLayer::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrDsnHk1NLayer");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrDsnHk1NLayer";
...
set<uint> QryPlnrDsnHk1NLayer::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDsnHk1NLayer::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDsnHk1NLayer::StatShr
 ******************************************************************************/

QryPlnrDsnHk1NLayer::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrDsnHk1NLayer::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrDsnHk1NLayer");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrDsnHk1NLayer";
...
set<uint> QryPlnrDsnHk1NLayer::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDsnHk1NLayer::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDsnHk1NLayer::StgIac
 ******************************************************************************/

QryPlnrDsnHk1NLayer::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrDsnHk1NLayer::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrDsnHk1NLayer");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrDsnHk1NLayer";
...
void QryPlnrDsnHk1NLayer::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrDsnHk1NLayer";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrDsnHk1NLayer";
...
set<uint> QryPlnrDsnHk1NLayer::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDsnHk1NLayer::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
