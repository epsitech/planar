/**
  ...
  * app access code for job QryPlnrMat1NLayer (implementation)
...
/******************************************************************************
 class QryPlnrMat1NLayer::StatApp
 ******************************************************************************/

QryPlnrMat1NLayer::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrMat1NLayer::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrMat1NLayer");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrMat1NLayer";
...
set<uint> QryPlnrMat1NLayer::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrMat1NLayer::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrMat1NLayer::StatShr
 ******************************************************************************/

QryPlnrMat1NLayer::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrMat1NLayer::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrMat1NLayer");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrMat1NLayer";
...
set<uint> QryPlnrMat1NLayer::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrMat1NLayer::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrMat1NLayer::StgIac
 ******************************************************************************/

QryPlnrMat1NLayer::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrMat1NLayer::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrMat1NLayer");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrMat1NLayer";
...
void QryPlnrMat1NLayer::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrMat1NLayer";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrMat1NLayer";
...
set<uint> QryPlnrMat1NLayer::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrMat1NLayer::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
