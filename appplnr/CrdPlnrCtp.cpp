/**
  * \file CrdPlnrCtp.cpp
  * app access code for job CrdPlnrCtp (implementation)
...
/******************************************************************************
 class CrdPlnrCtp::VecVDo
 ******************************************************************************/

uint CrdPlnrCtp::VecVDo::getIx(
			const string& sref
		) {
...
string CrdPlnrCtp::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrCtp::VecVSge
 ******************************************************************************/

uint CrdPlnrCtp::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdPlnrCtp::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrCtp::ContInf
 ******************************************************************************/

CrdPlnrCtp::ContInf::ContInf(
			const uint numFSge
...
bool CrdPlnrCtp::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfPlnrCtp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfPlnrCtp";
...
set<uint> CrdPlnrCtp::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
	...
	if (MtxCrdCtp.compare(comp->MtxCrdCtp) == 0) insert(items, MTXCRDCTP);

	return(items);
};

set<uint> CrdPlnrCtp::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdPlnrCtp::StatApp
 ******************************************************************************/

CrdPlnrCtp::StatApp::StatApp(
...
bool CrdPlnrCtp::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppPlnrCtp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppPlnrCtp";
...
set<uint> CrdPlnrCtp::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrCtp::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdPlnrCtp::StatShr
 ******************************************************************************/

CrdPlnrCtp::StatShr::StatShr(
...
bool CrdPlnrCtp::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrPlnrCtp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrPlnrCtp";
...
set<uint> CrdPlnrCtp::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrCtp::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdPlnrCtp::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagPlnrCtp");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemPlnrCtp";
...
/******************************************************************************
 class CrdPlnrCtp::DpchAppDo
 ******************************************************************************/

CrdPlnrCtp::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppPlnr(VecPlnrVDpch::DPCHAPPPLNRCTPDO, scrJref) {
...
void CrdPlnrCtp::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppPlnrCtpDo");
...
/******************************************************************************
 class CrdPlnrCtp::DpchEngData
 ******************************************************************************/

CrdPlnrCtp::DpchEngData::DpchEngData() : DpchEngPlnr(VecPlnrVDpch::DPCHENGPLNRCTPDATA) {
	feedFSge.tag = "FeedFSge";
};

void CrdPlnrCtp::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngPlnrCtpData");
	else
		basefound = checkXPath(docctx, basexpath);
