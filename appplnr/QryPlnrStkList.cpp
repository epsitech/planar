/**
  ...
  * app access code for job QryPlnrStkList (implementation)
...
/******************************************************************************
 class QryPlnrStkList::VecVOrd
 ******************************************************************************/

uint QryPlnrStkList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryPlnrStkList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryPlnrStkList::StatApp
 ******************************************************************************/

QryPlnrStkList::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrStkList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrStkList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrStkList";
...
set<uint> QryPlnrStkList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrStkList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrStkList::StatShr
 ******************************************************************************/

QryPlnrStkList::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrStkList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrStkList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrStkList";
...
set<uint> QryPlnrStkList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrStkList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrStkList::StgIac
 ******************************************************************************/

QryPlnrStkList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrStkList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrStkList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrStkList";
...
void QryPlnrStkList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrStkList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrStkList";
...
set<uint> QryPlnrStkList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrStkList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
