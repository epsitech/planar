/**
  ...
  * app access code for job QryPlnrLyrMNStructure (implementation)
...
/******************************************************************************
 class QryPlnrLyrMNStructure::StatApp
 ******************************************************************************/

QryPlnrLyrMNStructure::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrLyrMNStructure::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrLyrMNStructure");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrLyrMNStructure";
...
set<uint> QryPlnrLyrMNStructure::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrLyrMNStructure::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrLyrMNStructure::StatShr
 ******************************************************************************/

QryPlnrLyrMNStructure::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrLyrMNStructure::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrLyrMNStructure");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrLyrMNStructure";
...
set<uint> QryPlnrLyrMNStructure::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrLyrMNStructure::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrLyrMNStructure::StgIac
 ******************************************************************************/

QryPlnrLyrMNStructure::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrLyrMNStructure::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrLyrMNStructure");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrLyrMNStructure";
...
void QryPlnrLyrMNStructure::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrLyrMNStructure";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrLyrMNStructure";
...
set<uint> QryPlnrLyrMNStructure::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrLyrMNStructure::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
