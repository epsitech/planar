/**
  ...
  * app access code for job PnlPlnrCliDetail (declarations)
...
namespace PnlPlnrCliDetail {
	...
	public:
		...
		static const uint CPTCAL = 3;
		static const uint CPTDSN = 4;

	public:
		Tag(const string& Cpt = "", const string& CptTit = "", const string& CptCal = "", const string& CptDsn = "");
