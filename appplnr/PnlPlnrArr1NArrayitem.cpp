/**
  ...
  * app access code for job PnlPlnrArr1NArrayitem (implementation)
...
bool PnlPlnrArr1NArrayitem::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfPlnrArr1NArrayitem");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfPlnrArr1NArrayitem";
...
PnlPlnrArr1NArrayitem::StatApp::StatApp(
...
bool PnlPlnrArr1NArrayitem::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppPlnrArr1NArrayitem");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppPlnrArr1NArrayitem";
...
set<uint> PnlPlnrArr1NArrayitem::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> PnlPlnrArr1NArrayitem::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool PnlPlnrArr1NArrayitem::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrPlnrArr1NArrayitem");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrPlnrArr1NArrayitem";
...
bool PnlPlnrArr1NArrayitem::Tag::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagPlnrArr1NArrayitem");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemPlnrArr1NArrayitem";
...
PnlPlnrArr1NArrayitem::DpchAppData::DpchAppData(
			const string& scrJref
			, StgIac* stgiac
			, QryPlnrArr1NArrayitem::StgIac* stgiacqry
			, const set<uint>& mask
		) : DpchAppPlnr(VecPlnrVDpch::DPCHAPPPLNRARR1NARRAYITEMDATA, scrJref) {
...
void PnlPlnrArr1NArrayitem::DpchAppData::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppPlnrArr1NArrayitemData");
...
PnlPlnrArr1NArrayitem::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppPlnr(VecPlnrVDpch::DPCHAPPPLNRARR1NARRAYITEMDO, scrJref) {
...
void PnlPlnrArr1NArrayitem::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppPlnrArr1NArrayitemDo");
	xmlTextWriterWriteAttribute(wr, BAD_CAST "xmlns", BAD_CAST "http://www.epsitechnologies.com/plnr");
		if (has(SCRJREF)) writeString(wr, "scrJref", scrJref);
...
PnlPlnrArr1NArrayitem::DpchEngData::DpchEngData() : DpchEngPlnr(VecPlnrVDpch::DPCHENGPLNRARR1NARRAYITEMDATA) {
	feedFCsiQst.tag = "FeedFCsiQst";
};

void PnlPlnrArr1NArrayitem::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngPlnrArr1NArrayitemData");
	else
		basefound = checkXPath(docctx, basexpath);
	...
	if (basefound) {
		...
		tag = Tag();
		rst.clear();
		statappqry = QryPlnrArr1NArrayitem::StatApp();
		statshrqry = QryPlnrArr1NArrayitem::StatShr();
