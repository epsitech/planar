/**
  ...
  * app access code for job QryPlnrSruMNLayer (implementation)
...
/******************************************************************************
 class QryPlnrSruMNLayer::StatApp
 ******************************************************************************/

QryPlnrSruMNLayer::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrSruMNLayer::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrSruMNLayer");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrSruMNLayer";
...
set<uint> QryPlnrSruMNLayer::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrSruMNLayer::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrSruMNLayer::StatShr
 ******************************************************************************/

QryPlnrSruMNLayer::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrSruMNLayer::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrSruMNLayer");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrSruMNLayer";
...
set<uint> QryPlnrSruMNLayer::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrSruMNLayer::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrSruMNLayer::StgIac
 ******************************************************************************/

QryPlnrSruMNLayer::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrSruMNLayer::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrSruMNLayer");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrSruMNLayer";
...
void QryPlnrSruMNLayer::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrSruMNLayer";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrSruMNLayer";
...
set<uint> QryPlnrSruMNLayer::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrSruMNLayer::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
