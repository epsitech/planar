/**
  ...
  * app access code for job QryPlnrTpoMNProject (implementation)
...
/******************************************************************************
 class QryPlnrTpoMNProject::StatApp
 ******************************************************************************/

QryPlnrTpoMNProject::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrTpoMNProject::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrTpoMNProject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrTpoMNProject";
...
set<uint> QryPlnrTpoMNProject::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpoMNProject::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrTpoMNProject::StatShr
 ******************************************************************************/

QryPlnrTpoMNProject::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrTpoMNProject::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrTpoMNProject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrTpoMNProject";
...
set<uint> QryPlnrTpoMNProject::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpoMNProject::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrTpoMNProject::StgIac
 ******************************************************************************/

QryPlnrTpoMNProject::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrTpoMNProject::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrTpoMNProject");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrTpoMNProject";
...
void QryPlnrTpoMNProject::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrTpoMNProject";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrTpoMNProject";
...
set<uint> QryPlnrTpoMNProject::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpoMNProject::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
