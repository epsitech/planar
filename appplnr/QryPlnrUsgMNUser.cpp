/**
  ...
  * app access code for job QryPlnrUsgMNUser (implementation)
...
/******************************************************************************
 class QryPlnrUsgMNUser::StatApp
 ******************************************************************************/

QryPlnrUsgMNUser::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrUsgMNUser::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrUsgMNUser";
...
set<uint> QryPlnrUsgMNUser::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrUsgMNUser::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrUsgMNUser::StatShr
 ******************************************************************************/

QryPlnrUsgMNUser::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrUsgMNUser::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrUsgMNUser";
...
set<uint> QryPlnrUsgMNUser::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrUsgMNUser::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrUsgMNUser::StgIac
 ******************************************************************************/

QryPlnrUsgMNUser::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrUsgMNUser::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrUsgMNUser");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrUsgMNUser";
...
void QryPlnrUsgMNUser::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrUsgMNUser";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrUsgMNUser";
...
set<uint> QryPlnrUsgMNUser::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrUsgMNUser::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
