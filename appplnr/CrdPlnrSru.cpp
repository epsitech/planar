/**
  * \file CrdPlnrSru.cpp
  * app access code for job CrdPlnrSru (implementation)
...
/******************************************************************************
 class CrdPlnrSru::VecVDo
 ******************************************************************************/

uint CrdPlnrSru::VecVDo::getIx(
			const string& sref
		) {
...
string CrdPlnrSru::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrSru::VecVSge
 ******************************************************************************/

uint CrdPlnrSru::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdPlnrSru::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrSru::ContInf
 ******************************************************************************/

CrdPlnrSru::ContInf::ContInf(
			const uint numFSge
			, const string& MrlAppHlp
			, const string& MtxCrdSru
		) : Block() {
	this->numFSge = numFSge;
	this->MrlAppHlp = MrlAppHlp;
	this->MtxCrdSru = MtxCrdSru;

	mask = {NUMFSGE, MRLAPPHLP, MTXCRDSRU};
};

bool CrdPlnrSru::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfPlnrSru");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfPlnrSru";

	if (basefound) {
		if (extractUintAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "numFSge", numFSge)) add(NUMFSGE);
		if (extractStringAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "MrlAppHlp", MrlAppHlp)) add(MRLAPPHLP);
		if (extractStringAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "MtxCrdSru", MtxCrdSru)) add(MTXCRDSRU);
	};

	return basefound;
};

set<uint> CrdPlnrSru::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
	...
	if (MtxCrdSru.compare(comp->MtxCrdSru) == 0) insert(items, MTXCRDSRU);

	return(items);
};

set<uint> CrdPlnrSru::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {NUMFSGE, MRLAPPHLP, MTXCRDSRU};
...
/******************************************************************************
 class CrdPlnrSru::StatApp
 ******************************************************************************/

CrdPlnrSru::StatApp::StatApp(
...
bool CrdPlnrSru::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppPlnrSru");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppPlnrSru";
...
set<uint> CrdPlnrSru::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrSru::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdPlnrSru::StatShr
 ******************************************************************************/

CrdPlnrSru::StatShr::StatShr(
...
bool CrdPlnrSru::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrPlnrSru");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrPlnrSru";
...
set<uint> CrdPlnrSru::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrSru::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdPlnrSru::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagPlnrSru");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemPlnrSru";
...
/******************************************************************************
 class CrdPlnrSru::DpchAppDo
 ******************************************************************************/

CrdPlnrSru::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppPlnr(VecPlnrVDpch::DPCHAPPPLNRSRUDO, scrJref) {
...
void CrdPlnrSru::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppPlnrSruDo");
...
/******************************************************************************
 class CrdPlnrSru::DpchEngData
 ******************************************************************************/

CrdPlnrSru::DpchEngData::DpchEngData() : DpchEngPlnr(VecPlnrVDpch::DPCHENGPLNRSRUDATA) {
	feedFSge.tag = "FeedFSge";
};

void CrdPlnrSru::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngPlnrSruData");
	else
		basefound = checkXPath(docctx, basexpath);
