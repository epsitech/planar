/**
  ...
  * app access code for job QryPlnrTpoHk1NReticle (implementation)
...
/******************************************************************************
 class QryPlnrTpoHk1NReticle::StatApp
 ******************************************************************************/

QryPlnrTpoHk1NReticle::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrTpoHk1NReticle::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrTpoHk1NReticle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrTpoHk1NReticle";
...
set<uint> QryPlnrTpoHk1NReticle::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpoHk1NReticle::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrTpoHk1NReticle::StatShr
 ******************************************************************************/

QryPlnrTpoHk1NReticle::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrTpoHk1NReticle::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrTpoHk1NReticle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrTpoHk1NReticle";
...
set<uint> QryPlnrTpoHk1NReticle::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpoHk1NReticle::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrTpoHk1NReticle::StgIac
 ******************************************************************************/

QryPlnrTpoHk1NReticle::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrTpoHk1NReticle::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrTpoHk1NReticle");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrTpoHk1NReticle";
...
void QryPlnrTpoHk1NReticle::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrTpoHk1NReticle";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrTpoHk1NReticle";
...
set<uint> QryPlnrTpoHk1NReticle::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpoHk1NReticle::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
