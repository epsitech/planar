/**
  ...
  * app access code for job QryPlnrClcList (declarations)
...
namespace QryPlnrClcList {
	...
	public:
		StatApp(const uint firstcol = 1, const uint jnumFirstdisp = 1, const uint ncol = 7, const uint ndisp = 25);
