/**
  ...
  * app access code for job QryPlnrCtpKCalcvar (implementation)
...
/******************************************************************************
 class QryPlnrCtpKCalcvar::StatApp
 ******************************************************************************/

QryPlnrCtpKCalcvar::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrCtpKCalcvar::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrCtpKCalcvar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrCtpKCalcvar";
...
set<uint> QryPlnrCtpKCalcvar::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrCtpKCalcvar::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrCtpKCalcvar::StatShr
 ******************************************************************************/

QryPlnrCtpKCalcvar::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrCtpKCalcvar::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrCtpKCalcvar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrCtpKCalcvar";
...
set<uint> QryPlnrCtpKCalcvar::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrCtpKCalcvar::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrCtpKCalcvar::StgIac
 ******************************************************************************/

QryPlnrCtpKCalcvar::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrCtpKCalcvar::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrCtpKCalcvar");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrCtpKCalcvar";
...
void QryPlnrCtpKCalcvar::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrCtpKCalcvar";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrCtpKCalcvar";
...
set<uint> QryPlnrCtpKCalcvar::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrCtpKCalcvar::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
