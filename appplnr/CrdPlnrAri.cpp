/**
  * \file CrdPlnrAri.cpp
  * app access code for job CrdPlnrAri (implementation)
...
/******************************************************************************
 class CrdPlnrAri::VecVDo
 ******************************************************************************/

uint CrdPlnrAri::VecVDo::getIx(
			const string& sref
		) {
...
string CrdPlnrAri::VecVDo::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrAri::VecVSge
 ******************************************************************************/

uint CrdPlnrAri::VecVSge::getIx(
			const string& sref
		) {
	string s = StrMod::lc(sref);
...
string CrdPlnrAri::VecVSge::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class CrdPlnrAri::ContInf
 ******************************************************************************/

CrdPlnrAri::ContInf::ContInf(
			const uint numFSge
			, const string& MrlAppHlp
			, const string& MtxCrdAri
		) : Block() {
	this->numFSge = numFSge;
	this->MrlAppHlp = MrlAppHlp;
	this->MtxCrdAri = MtxCrdAri;

	mask = {NUMFSGE, MRLAPPHLP, MTXCRDARI};
};

bool CrdPlnrAri::ContInf::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "ContInfPlnrAri");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "ContitemInfPlnrAri";

	if (basefound) {
		if (extractUintAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "numFSge", numFSge)) add(NUMFSGE);
		if (extractStringAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "MrlAppHlp", MrlAppHlp)) add(MRLAPPHLP);
		if (extractStringAttrUclc(docctx, basexpath, itemtag, "Ci", "sref", "MtxCrdAri", MtxCrdAri)) add(MTXCRDARI);
	};

	return basefound;
};

set<uint> CrdPlnrAri::ContInf::comm(
			const ContInf* comp
		) {
	set<uint> items;
	...
	if (MtxCrdAri.compare(comp->MtxCrdAri) == 0) insert(items, MTXCRDARI);

	return(items);
};

set<uint> CrdPlnrAri::ContInf::diff(
			const ContInf* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
	...
	diffitems = {NUMFSGE, MRLAPPHLP, MTXCRDARI};
...
/******************************************************************************
 class CrdPlnrAri::StatApp
 ******************************************************************************/

CrdPlnrAri::StatApp::StatApp(
...
bool CrdPlnrAri::StatApp::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppPlnrAri");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppPlnrAri";
...
set<uint> CrdPlnrAri::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrAri::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class CrdPlnrAri::StatShr
 ******************************************************************************/

CrdPlnrAri::StatShr::StatShr(
...
bool CrdPlnrAri::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrPlnrAri");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrPlnrAri";
...
set<uint> CrdPlnrAri::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> CrdPlnrAri::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
bool CrdPlnrAri::Tag::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "TagPlnrAri");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "TagitemPlnrAri";
...
/******************************************************************************
 class CrdPlnrAri::DpchAppDo
 ******************************************************************************/

CrdPlnrAri::DpchAppDo::DpchAppDo(
			const string& scrJref
			, const uint ixVDo
			, const set<uint>& mask
		) : DpchAppPlnr(VecPlnrVDpch::DPCHAPPPLNRARIDO, scrJref) {
...
void CrdPlnrAri::DpchAppDo::writeXML(
			xmlTextWriter* wr
		) {
	xmlTextWriterStartElement(wr, BAD_CAST "DpchAppPlnrAriDo");
...
/******************************************************************************
 class CrdPlnrAri::DpchEngData
 ******************************************************************************/

CrdPlnrAri::DpchEngData::DpchEngData() : DpchEngPlnr(VecPlnrVDpch::DPCHENGPLNRARIDATA) {
	feedFSge.tag = "FeedFSge";
};

void CrdPlnrAri::DpchEngData::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "DpchEngPlnrAriData");
	else
		basefound = checkXPath(docctx, basexpath);
