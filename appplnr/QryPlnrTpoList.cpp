/**
  ...
  * app access code for job QryPlnrTpoList (implementation)
...
/******************************************************************************
 class QryPlnrTpoList::VecVOrd
 ******************************************************************************/

uint QryPlnrTpoList::VecVOrd::getIx(
			const string& sref
		) {
...
string QryPlnrTpoList::VecVOrd::getSref(
			const uint ix
		) {
...
/******************************************************************************
 class QryPlnrTpoList::StatApp
 ******************************************************************************/

QryPlnrTpoList::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrTpoList::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrTpoList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrTpoList";
...
set<uint> QryPlnrTpoList::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpoList::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrTpoList::StatShr
 ******************************************************************************/

QryPlnrTpoList::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrTpoList::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrTpoList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrTpoList";
...
set<uint> QryPlnrTpoList::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpoList::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrTpoList::StgIac
 ******************************************************************************/

QryPlnrTpoList::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrTpoList::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrTpoList");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrTpoList";
...
void QryPlnrTpoList::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrTpoList";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrTpoList";
...
set<uint> QryPlnrTpoList::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrTpoList::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
