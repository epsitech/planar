/**
  ...
  * app access code for job PnlPlnrDsnDsn1NStack (declarations)
...
/**
  ...
  */
namespace PnlPlnrDsnDsn1NStack {
	/**
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrDsnDsn1NStack::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrDsnDsn1NStack::StatApp statappqry;
