/**
  ...
  * app access code for job PnlPlnrPrj1NCalc (declarations)
...
namespace PnlPlnrPrj1NCalc {
	...
	public:
		DpchAppData(const string& scrJref = "", StgIac* stgiac = NULL, QryPlnrPrj1NCalc::StgIac* stgiacqry = NULL, const set<uint>& mask = {NONE});
	...
	public:
		...
		QryPlnrPrj1NCalc::StatApp statappqry;
