/**
  ...
  * app access code for job QryPlnrDvcHk1NArcguide (implementation)
...
/******************************************************************************
 class QryPlnrDvcHk1NArcguide::StatApp
 ******************************************************************************/

QryPlnrDvcHk1NArcguide::StatApp::StatApp(
			const uint firstcol
...
bool QryPlnrDvcHk1NArcguide::StatApp::readXML(
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatAppQryPlnrDvcHk1NArcguide");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemAppQryPlnrDvcHk1NArcguide";
...
set<uint> QryPlnrDvcHk1NArcguide::StatApp::comm(
			const StatApp* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDvcHk1NArcguide::StatApp::diff(
			const StatApp* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDvcHk1NArcguide::StatShr
 ******************************************************************************/

QryPlnrDvcHk1NArcguide::StatShr::StatShr(
			const uint ntot
...
bool QryPlnrDvcHk1NArcguide::StatShr::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StatShrQryPlnrDvcHk1NArcguide");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StatitemShrQryPlnrDvcHk1NArcguide";
...
set<uint> QryPlnrDvcHk1NArcguide::StatShr::comm(
			const StatShr* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDvcHk1NArcguide::StatShr::diff(
			const StatShr* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
...
/******************************************************************************
 class QryPlnrDvcHk1NArcguide::StgIac
 ******************************************************************************/

QryPlnrDvcHk1NArcguide::StgIac::StgIac(
			const uint jnum
			, const uint jnumFirstload
			, const uint nload
		) : Block() {
...
bool QryPlnrDvcHk1NArcguide::StgIac::readXML(
			xmlXPathContext* docctx
			, string basexpath
			, bool addbasetag
		) {
	...
	if (addbasetag)
		basefound = checkUclcXPaths(docctx, basexpath, basexpath, "StgIacQryPlnrDvcHk1NArcguide");
	else
		basefound = checkXPath(docctx, basexpath);

	string itemtag = "StgitemIacQryPlnrDvcHk1NArcguide";
...
void QryPlnrDvcHk1NArcguide::StgIac::writeXML(
			xmlTextWriter* wr
			, string difftag
			, bool shorttags
		) {
	if (difftag.length() == 0) difftag = "StgIacQryPlnrDvcHk1NArcguide";

	string itemtag;
	if (shorttags) itemtag = "Si";
	else itemtag = "StgitemIacQryPlnrDvcHk1NArcguide";
...
set<uint> QryPlnrDvcHk1NArcguide::StgIac::comm(
			const StgIac* comp
		) {
	set<uint> items;
...
set<uint> QryPlnrDvcHk1NArcguide::StgIac::diff(
			const StgIac* comp
		) {
	set<uint> commitems;
	set<uint> diffitems;
